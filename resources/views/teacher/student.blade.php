        ...
        <div class="relative overflow rounded-lg z-10">
            <table class="w-full text-sm text-left rtl:text-right text-white dark:text-white">
                ...
                <tr class="hover:bg-violet-100 dark:hover:bg-gray-700 transition duration-300 border-b dark:border-gray-600 hover:border-violet-400 dark:text-gray-200 text-gray-500">
                    ...
                    <td class="px-6 py-3">
                        <div class="flex items-center">
                            <P class="h-2.5 w-2.5 rounded-full {{ $teacherStudent->status == 1 ? 'bg-emerald-500' : 'bg-red-500' }} me-2"></P>
                            <p>{{ $teacherStudent->status == 1 ? 'Actif' : 'Inactif' }}</p>
                        </div>
                    </td>
                    <td class="px-6 py-3">
                        {{ $teacherStudent -> mobile_number }}
                    </td>
                    <td class="px-6 py-3">
                        <div class="flex items-center">
                            <p class="px-6 py-1 rounded-full {{ $teacherStudent->gender == 'male' ? 'text-violet-700 dark:text-gray-200 bg-violet-100 dark:bg-violet-900' : ($teacherStudent->gender == 'female' ? 'text-red-700 dark:text-gray-200 bg-red-100 dark:bg-red-900' : 'text-pink-700 dark:text-gray-200 bg-pink-100 dark:bg-pink-900') }}">
                ...
                <tr class="text-center text-gray-700 dark:text-bodydark1">
                    <td colspan="9" class="px-6 py-3"> Aucun apprenant assigné ne vous a été assigné.</td>
                </tr>
                @endif
                <tr class="">
                    <td colspan="9"
