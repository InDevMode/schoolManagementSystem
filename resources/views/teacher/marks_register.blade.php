                                    ...
                                    <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-gray-100 dark:bg-form-input">
                                          <select id="exam_id" name="exam_id" required
                                                ...
                                                @foreach ($getExams as $exams)
                                                      <option value="{{ $exams->exam_id }}" class="text-body"
                                                            {{ Request::get('exam_id') == $exams->exam_id ? 'selected' : '' }}>
                                                            {{ $exams->exam_name }}</option>
                                                @endforeach
                                          </select>
                              ...
                              <div class="w-full">
                                    <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-gray-100 dark:bg-form-input">
                                          <select id="class_id" name="class_id" required
                                                ...
                                                :class="isOptionSelected && 'text-black dark:text-white'"
                                                @change="isOptionSelected = true">
                                                <option disabled selected value="" class="text-body">Choisissez une
                                                      classe</option>
                                                            ...
                                                            <tr
                                                                                          ...
                                                                                          <label
                                                                                                ...
                                                                                                <div
                                                                                                      ...
                                                                                                      <p
                                                                                                            class="flex justify-between">
                                                                                                            <span>Décision
                                                                                                                  =></span><span>{{ $totalMark >= $subject->passing_marks ? 'Admis' : 'Refusé' }}</span>
                                                                                                      </p>
                                                                                                      @if (!empty($getGrade))
                                                                                                            <p>Note =>
                                                                                                                  {{ $getGrade }}
                                                                  ...
                                                                  <td class="px-6 py-3">
                                                                        ...
                                                                        <div
                                                                              ...
                                                                              <p>Note de passage => {{ $totalPassingMarks }}
                                                                              </p>
                                                                              <p>Pourcentage => {{ round($percentage, 2) }} %
                                                                              </p>
                                                                              @if (!empty($getGrade))
                                                                                    <p>Note => {{ $getGrade }}
                                                                              @endif
                                          ...
                                          @else
                                                <tr>
                                                      <td colspan="{{ count($getSubject) + 2 }}"
                                                            class="px-6 py-3 text-center dark:text-gray-400 font-medium">
