            ...
            <div
                  ...
                  <form action="" method="get">
                        <div class="mb-4.5 grid grid-cols-2 xl:grid-cols-5 gap-3 items-center">
                              ...
                              <div class="w-full">
                                    <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-gray-100 dark:bg-form-input">
                                          <select id="class_id" name="class_id"
                                                ...
                                                <option selected disabled value="" class="text-body">Choisissez une
                                                      classe</option>
                                                @foreach ($getClass as $class)
                                                      <option value="{{ $class->class_id }}" class="text-body"
                              ...
                              <div class="w-full">
                                    <div class="relative">
                                          <input id="start_attendance_date" name="start_attendance_date"
                              ...
                              <div class="w-full">
                                    <div class="relative">
                                          <input id="end_attendance_date" name="end_attendance_date"
                              ...
                              <div class="w-full">
                                    <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-gray-100 dark:bg-form-input">
                                          <select id="attendance_type" name="attendance_type"
                                                ...
                                                :class="isOptionSelected && 'text-black dark:text-white'"
                                                @change="isOptionSelected = true">
                                                <option selected disabled value="" class="text-body">Choisissez la
                                                      présence</option>
                              ...
                              <tbody>
                                    @if (!empty($getStudentAttendance))
                                          @if (!empty($getStudentAttendance) && $getStudentAttendance->count() > 0)
                                                            ...
                                                            <td class="px-6 py-4">
                                                                  <span
                                                                      ...
                                                                      {{ $studentAttendance->attendance_type == 1
                                                                          ? 'bg-emerald-200 text-emerald-800 rounded-full px-2 py-1'
                                                                          : ($studentAttendance->attendance_type == 2
                                                                              ...
                                                                              : ($studentAttendance->attendance_type == 3
                                                                                  ? 'bg-red-200 text-red-800 rounded-full px-2 py-1'
                                                                                  : ($studentAttendance->attendance_type == 4
                                                                                      ? 'bg-blue-200 text-blue-800 rounded-full px-2 py-1'
                                                                                      : ''))) }}">
                                                                        {{ $studentAttendance->attendance_type == 1
                                                                            ? 'Présent(e)'
                                                                            : ($studentAttendance->attendance_type == 2
                                                ...
                                                @endforeach
                                          @else
                                                <tr class="p-4 text-gray-700 rounded-lg shadow-md text-center">
                                    ...
                                    @else
                                          <tr class="p-4 text-gray-700 rounded-lg shadow-md text-center">
                                                <td colspan="100%" class="px-6 py-3"> Aucun rapport d'apprenant trouvé.</td>
                                          </tr>
                                    @endif
                              </tbody>
                        </table>
