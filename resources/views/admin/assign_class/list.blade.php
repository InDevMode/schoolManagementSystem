    ...
    >
        ...
        <nav>
            <ol class="flex items-center gap-2">
                ...
                <li>
                    /<a class="font-medium hover:text-violet-600 transition duration-300"
                        href="{{ url('admin/assign_class/add') }}"> Assignez une classe</a>
                </li>
            </ol>
        </nav>
    </div>
                ...
                <tr class="hover:bg-violet-100 dark:hover:bg-gray-700 transition duration-300 border-b dark:border-gray-600 hover:border-violet-400 dark:text-gray-200 text-gray-500">
                    ...
                    <td class="px-6 py-3">
                        <div class="flex items-center">
                            <P class="h-2.5 w-2.5 rounded-full {{ $classTeacher->status == 1 ? 'bg-emerald-500' : 'bg-red-500' }} me-2"></P>
                            <p>{{ $classTeacher->status == 1 ? 'Actif' : 'Inactif' }}</p>
                        </div>
                    </td>
                    <td class="px-6 py-3">
