                                ...
                                <div class="mb-4.5">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <option class="text-body" value="{{ $class->id }}" {{ $getClassTeacher->
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="flex flex-auto flex-wrap gap-3">
                                                                ...
                                                                <div x-show="selected.length == 0" class="flex-1">
                                                                    <input
                                                                        placeholder="Choisissez un ou plusieurs professeur(s)"
                                ...
                                <div class="mb-4.5">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            'status', $getClassTeacher->status) == '1') ? 'selected' : ''
                                            }}>Activée</option>
                                            <option class="text-body" value="0" {{ (old(
                                            'status', $getClassTeacher->status) == '0') ? 'selected' : ''
                                            }}>Désactivée</option>
                                        </select>
                                        <span
                                            class="absolute right-4 top-1/2 z-30 -translate-y-1/2"
