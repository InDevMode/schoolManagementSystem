            ...
            <div class="container mx-auto px-4 py-8 max-w-6xl">
                  ...
                  <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
                        <div class="mb-4 md:mb-0">
                              ...
                              <p class="text-gray-600 dark:text-gray-300 mt-1">Voir les détails du profile de cet
                                    administrateur
                              </p>
                        </div>
                                    ...
                                    <li aria-current="page">
                                          <div class="flex items-center">
                                                <iconify-icon icon="mdi:chevron-right" class="text-gray-400" width="16"
                                                      height="16"></iconify-icon>
                                                <span
                                                      class="ml-1 text-sm font-medium text-emerald-600 md:ml-2 dark:text-emerald-600">Profile</span>
                                          </div>
                                    </li>
                              </ol>
                        </nav>
                                    ...
                                    <div class="mb-6">
                                          ...
                                          <div class="relative">
                                                <input type="file" id="profile_picture" name="profile_picture"
                                                      value="{{ old('profile_picture', $getUserData->profile_picture) }}"
                                          ...
                                          <div class="mb-6 w-full">
                                                ...
                                                <div class="relative">
                                                      <input type="text" id="name" name="name"
                                                            value="{{ old('name', $getUserData->name) }}" required
                                          ...
                                          <div class="relative">
                                                <select id="status" name="status" required
                                                      ...
                                                      <option selected disabled value="">Veuillez choisir un
                                                            status pour cet administrateur
                                                      <option value="1"
                                                            {{ old('status', $getUserData->status) == '1' ? 'selected' : '' }}>
                                                            Active
                                                      </option>
                                                      <option value="0"
                                                            {{ old('status', $getUserData->status) == '0' ? 'selected' : '' }}>
                                                            Inactive</option>
                                                </select>
                                                <div
