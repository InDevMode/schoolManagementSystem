        ...
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            <div class="mx-auto max-w-242.5">
                ...
                >
                    ...
                    <nav>
                        <ol class="flex items-center gap-2">
                            <li>
                                <span class="font-medium text-violet-600"><i class="fa-solid fa-book-open-reader"></i></span>
                            </li>
                            <li>
                                /<a class="font-medium hover:text-violet-600 transition duration-300"
                                    href="{{ url('admin/assign_subject/list') }}"> Liste des matières assignées</a>
                            </li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="flex flex-col gap-9">
                    ...
                    >
                        <form action="{{ url('admin/assign_subject/add') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="p-6.5">
                                <div class="mb-4.5">
                                    <label
                                ...
                                <div class="mb-4.5">
                                    <label
                                        class="mb-3 block text-sm font-medium text-black dark:text-white"
                                    >
                                        Matières <span class="text-meta-1">*</span>
                                    </label>
                                    <div class="">
                                        <select class="hidden" x-cloak id="subject_id" name="subject_id[]">
                                            ...
                                            <div class="relative z-30 inline-block w-full">
                                                <div class="relative flex flex-col items-center">
                                                    <div @click="open" class="w-full">
                                                        <div
                                                            class="mb-2 flex rounded-lg border border-stroke py-2 pl-3 pr-3 outline-none bg-gray-100  transition focus:border-violet-600 active:border-violet-600 dark:border-form-strokedark dark:bg-form-input"
                                                        >
                                                            <div class="flex flex-auto flex-wrap gap-3">
                                                                ...
                                                                >
                                                                    <div
                                                                        class="my-1.5 flex items-center justify-center rounded-lg border-[.5px] border-stroke px-2.5 py-1.5 text-sm font-medium dark:border-strokedark dark:bg-white/30"
                                                                    >
                                                                        <div
                                                                ...
                                                                >
                                                                    <input
                                                                        placeholder="Choisissez une ou des matière(s) à cette classe"
                                                                        class="h-full w-full appearance-none bg-gray-100 p-1 px-2 outline-none"
                                                                        :value="selectedValues()"
                                                                    />
                                                                </div>
                                                            </div>
                                                        ...
                                                        >
                                                            <div class="flex w-full flex-col">
                                                                ...
                                                                >
                                                                    <div>
                                                                        <div
                                                                            class="w-full cursor-pointer rounded-t border-b border-stroke hover:bg-violet-600/5 dark:border-form-strokedark"
                                                                            @click="select(index,$event)"
                                                                        >
                                                                            <div
                                                                                :class="option.selected ? 'border-violet-600' : ''"
    ...
    function dropdown() {
        return {
            ...
            remove(index) {
                ...
                if (!option) return;
                if (!this.selected.some(selectedOption => selectedOption.value === option.value)) {
                    this.selected.push(option);
                }
            },
