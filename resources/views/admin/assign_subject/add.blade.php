            ...
            <div class="container mx-auto px-4 py-8 max-w-6xl">
                  ...
                  <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
                        <div class="mb-4 md:mb-0">
                              ...
                              <p class="text-gray-600 dark:text-gray-300 mt-1">Remplissez les détails pour assignez une matière
                                    à une classe
                              </p>
                        </div>
                        ...
                        <div class="p-6 md:p-8">
                              <form action="{{ url('admin/assign_subject/add') }}" method="post"
                                    ...
                                    <div class="mb-4.5">
                                          ...
                                          <div class="">
                                                <select class="hidden" x-cloak id="subject_id" name="subject_id[]" required
                                                      multiple>
                                                      ...
                                                      <div class="relative z-30 inline-block w-full">
                                                            <div class="relative flex flex-col items-center">
                                                                  <div @click="open" class="w-full">
                                                                        <div
                                                                              class="mb-2 flex rounded-lg border border-stroke py-2 pl-3 pr-3 outline-none transition bg-gray-50 dark:text-white dark:bg-gray-700 focus:border-violet-600 active:border-violet-600 dark:border-form-strokedark dark:bg-form-input">
                                                                              <div class="flex flex-auto flex-wrap gap-3">
                                                                                    <template
                                                                                          x-for="(option,index) in selected"
                                                                                          :key="index">
                                                                                          <div
                                                                                                class="my-1.5 flex items-center justify-center rounded-lg border-[.5px] border-stroke dark:text-white bg-gray-50 px-2.5 py-1.5 text-sm font-medium dark:border-strokedark dark:bg-white/30">
                                                                                    ...
                                                                                    <div x-show="selected.length == 0"
                                                                                          class="flex-1">
                                                                                          <input placeholder="Choisissez une ou plusieurs matière(s)"
                                                                                                class="custom-select dark:placeholder-white h-full w-full appearance-none bg-gray-50 dark:text-white dark:bg-gray-700 p-1 px-2 outline-none"
      ...
      <script>
            function dropdown() {
                  return {
                        ...
                        loadOptions() {
                              const options = document.getElementById("subject_id").options;
