            ...
            <div class="mx-auto max-w-242.5">
                ...
                >
                    <h2 class="uppercase font-bold text-black dark:text-bodydark">
                        Modifier une ou des matière(s) assignées à une classe
                    </h2>
                    <nav>
                                ...
                                <div class="mb-4.5">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <option class="text-body" value="{{ $class->id }}" {{ $getClassSubject->
                                            ...
                                            <div class="relative z-30 inline-block w-full">
                                                <div class="relative flex flex-col items-center">
                                                    <div @click="open" class="w-full">
                                                        <div
                                                            class="mb-2 flex rounded-lg border border-stroke py-2 pl-3 pr-3 outline-none transition focus:border-green-400 active:border-green-400 dark:border-form-strokedark dark:bg-form-input">
                                                            <div class="flex flex-auto flex-wrap gap-3">
                                                                ...
                                                                <div x-show="selected.length == 0" class="flex-1">
                                                                    <input
                                                                        placeholder="Choisissez une ou plusieurs matière(s)"
                                                        ...
                                                        <div x-show.transition.origin.top="isOpen()"
                                                            ...
                                                            <div class="flex w-full flex-col">
                                                                <template x-for="(option, index) in options"
                                                                    ...
                                                                    <div>
                                                                        <div
                                                                            class="w-full cursor-pointer rounded-t border-b border-stroke hover:bg-green-400/5 dark:border-form-strokedark"
                                                                            @click="select(index, $event)">
                                                                            <div
                                                                                :class="option.selected ? 'border-green-400' : ''"
                                ...
                                <div class="mb-4.5">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            'status', $getClassSubject->status) == '1') ? 'selected' : ''
                                            }}>Activée</option>
                                            <option class="text-body" value="0" {{ (old(
                                            'status', $getClassSubject->status) == '0') ? 'selected' : ''
                                            }}>Désactivée</option>
                                        </select>
                                        <span
                                            class="absolute right-4 top-1/2 z-30 -translate-y-1/2"
