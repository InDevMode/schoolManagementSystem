                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="p-6.5">
                                <div class="mb-4.5">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <option class="text-body" value="{{ $class->id }}" {{ $getClassSubject->class_id == $class->id ? 'selected' : '' }}>{{ $class->name}}
                                            </option>
                                            @endforeach
                                        </select>
                                        <span
                                ...
                                <div class="mb-4.5">
                                    ...
                                    <div>
                                        <select class="hidden" x-cloak id="subject_id" name="subject_id[]"  required multiple>
                                                        ...
                                                        <div class="mb-2 flex rounded-lg border border-stroke py-2 pl-3 pr-3 outline-none bg-gray-100 transition focus:border-emerald-400 active:border-emerald-400 dark:border-form-strokedark dark:bg-form-input">
                                                            <div class="flex flex-auto flex-wrap gap-3">
                                                                ...
                                                                <div x-show="selected.length == 0" class="flex-1">
                                                                    <input placeholder="Choisissez une ou des matière(s) à cette classe" class="h-full w-full appearance-none bg-gray-100 p-1 px-2 outline-none" />
                                                                </div>
                                                            </div>
                                ...
                                <div class="mb-4.5">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            'status', $getClassSubject->status) == '1') ? 'selected' : '' }}>Activée</option>
                                            <option class="text-body" value="0" {{ (old(
                                            'status', $getClassSubject->status) == '0') ? 'selected' : '' }}>Désactivée</option>
                                        </select>
                                        <span
                                            class="absolute right-4 top-1/2 z-30 -translate-y-1/2"
                                        >
