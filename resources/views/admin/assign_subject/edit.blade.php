                                                                        ...
                                                                        <div
                                                                              ...
                                                                              <div class="flex flex-auto flex-wrap gap-3">
                                                                                    <template
                                                                                          ...
                                                                                          :key="index">
                                                                                          <div
                                                                                                class="my-1.5 flex items-center justify-center rounded-lg dark:text-white border-[.5px] border-stroke bg-gray-50 px-2.5 py-1.5 text-sm font-medium dark:border-strokedark dark:bg-white/30">
