    ...
    >
        ...
        <nav>
            <ol class="flex items-center gap-2">
                ...
                <li>
                    /<a class="font-medium hover:text-violet-600 transition duration-300"
                        href="{{ url('admin/assign_subject/add') }}"> Assignez des matières</a>
                </li>
            </ol>
        </nav>
    </div>
    ...
    >
        <form action="" method="get">
            <div class="mb-4.5 grid grid-cols-2 xl:grid-cols-4 gap-3 items-center">
                ...
                <div class="w-full">
                    <input
                        type="text" id="teacher_name" name="teacher_name" value="{{ Request::get('subject_name') }}"
        ...
        <div class="relative overflow rounded-lg z-10">
            <table class="w-full text-[12px] text-left rtl:text-right text-white dark:text-white">
                ...
                <tr class="hover:bg-violet-100 dark:hover:bg-gray-700 transition duration-300 border-b dark:border-gray-600 hover:border-violet-400 dark:text-gray-200 text-gray-500">
                    ...
                    <td class="px-6 py-3">
                        <div class="flex items-center">
                            <P class="h-2.5 w-2.5 rounded-full {{ $classSubject->status == 1 ? 'bg-emerald-500' : 'bg-red-500' }} me-2"></P>
                            <p>{{ $classSubject->status == 1 ? 'Actif' : 'Inactif' }}</p>
                        </div>
                    </td>
                    <td class="px-6 py-3">
                    ...
                    <td class="px-6 py-3">
                        <div class="relative inline-block text-left" x-data="{ open: false }">
                            ...
                            <div
                                class="absolute right-0 z-50 mt-2 w-64 origin-top-right rounded-md bg-white dark:bg-gray-800 ring-1 shadow-lg ring-black/5 focus:outline-hidden"
                                role="menu"
                ...
                <tr class="text-center text-gray-700 dark:text-bodydark1">
                    <td colspan="9" class="px-6 py-3"> Aucune assignation de matières trouvée.</td>
                </tr>
                @endif
                <tr class="">
                    <td colspan="9"
