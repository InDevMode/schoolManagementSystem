                            ...
                            <div class="p-6.5">
                                ...
                                <div class="mb-4.5">
                                    <label
                                        class="mb-3 block text-sm font-medium text-black dark:text-white"
                                    >
                                        Matière <span class="text-meta-1">*</span>
                                    </label>
                                    <div
                                        x-data="{ isOptionSelected: false }"
                                        class="relative z-20 bg-gray-100 dark:bg-form-input"
                                    >
                                        ...
                                        >
                                            <option selected disabled value="" class="text-body">
                                                Choisissez une matière pour assignation
                                            </option>
                                ...
                                <div class="mb-4.5">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <option value="1" {{ old('status', $getClassSubject->status == 1) ? 'selected' : ''}}>Activée</option>
                                            <option value="0" {{ old('status', $getClassSubject->status == 0) ? 'selected' : ''}}>Désactivée</option>
                                        </select>
                                        <span
                                            class="absolute right-4 top-1/2 z-30 -translate-y-1/2"
                                        >
