    ...
    <div class="p-4 rounded-lg mt-14">
        ...
        <div class="relative overflow-visible shadow-md sm:rounded-lg border border-gray-300 z-10" id="results">
            <table class="w-full text-[10px] text-left rtl:text-right">
                ...
                <tr class="bg-white border-b hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4">
                         <span
                             class="bg-gray-100 text-gray-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded border border-gray-400">{{ $parent -> email }}</span>
                    </td>
                    <td class="px-6 py-4">
                        @if($parent->status == 0)
                        <div class="flex items-center">
            ...
            <div class="text-center bg-white py-2">
                <div class="flex justify-between items-center mt-4">
                    <span
                        class="text-violet-500 font-bold text-md ps-5 uppercase">Total : {{ $getParent->total() }}</span>
                </div>
            </div>
        </div>
        ...
        <div data-dial-init class="fixed end-6 bottom-6 group">
            <div id="speed-dial-menu-default" class="flex flex-col items-center hidden mb-4 space-y-2">
                <a href="{{ url('admin/parent/add') }}" data-tooltip-target="tooltip-administrates" data-tooltip-placement="left"
                   class="flex justify-center items-center w-full h-[52px] text-gray-500 hover:text-gray-900 bg-white rounded-full border border-gray-200 shadow-sm hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 focus:outline-none">
                    ...
                    <span class="sr-only">Créer un parent</span>
                </a>
