...
<div class="m-5">
    ...
    >
        <h2 class="uppercase font-bold text-black dark:text-bodydark">
            Liste des apprenants pour assignation
        </h2>
        <nav>
            <ol class="flex items-center gap-2">
                ...
                <li>
                    /<a class="font-medium hover:text-violet-600 transition duration-300"
                        href="{{ url('admin/student/add') }}"> Créer un apprenant</a>
                </li>
            </ol>
        </nav>
    </div>
        ...
        <div class="relative overflow rounded-lg z-10">
            <table class="w-full text-sm text-left rtl:text-right text-white dark:text-white">
                ...
                <tr class="hover:bg-violet-100 dark:hover:bg-gray-700 transition duration-300 border-b dark:border-gray-600 hover:border-violet-400 dark:text-gray-200 text-gray-500">
                    <td class="px-6 py-3">
                        {{ $studentList -> name }} {{ $studentList -> last_name }}
                    </td>
                    ...
                    <td class="px-6 py-3">
                        <div class="flex items-center">
                            <P class="h-2.5 w-2.5 rounded-full {{ $studentList->status == 1 ? 'bg-emerald-500' : 'bg-red-500' }} me-2"></P>
                            <p>{{ $studentList->status == 1 ? 'Actif' : 'Inactif' }}</p>
                        </div>
                    </td>
                    <td class="px-6 py-3">
                        <div class="flex items-center">
                            <p class="px-6 py-1 rounded-full {{ $studentList->gender == 'male' ? 'text-violet-700 dark:text-gray-200 bg-violet-100 dark:bg-violet-900' : ($studentList->gender == 'female' ? 'text-red-700 dark:text-gray-200 bg-red-100 dark:bg-red-900' : 'text-pink-700 dark:text-gray-200 bg-pink-100 dark:bg-pink-900') }}">
...
<div class="mt-10">
    ...
    >
        <h2 class="uppercase font-bold text-black dark:text-bodydark">
            Liste des apprenants assignés à un parent
        </h2>
        <nav>
            <ol class="flex items-center gap-2">
                <li>
                ...
                <li>
                    /<a class="font-medium hover:text-violet-600 transition duration-300"
                        href="{{ url('admin/parent/list') }}"> Liste des parents</a>
                </li>
                <li>
                    /<a class="font-medium hover:text-violet-600 transition duration-300"
        ...
        <div class="relative overflow rounded-lg z-10">
            <table class="w-full text-sm text-left rtl:text-right text-white dark:text-white">
                ...
                <tr class="hover:bg-violet-100 dark:hover:bg-gray-700 transition duration-300 border-b dark:border-gray-600 hover:border-violet-400 dark:text-gray-200 text-gray-500">
                    ...
                    <td class="px-6 py-3">
                        {{ $myStudent->parent_name }} {{ $myStudent->parent_last_name }}
                    </td>
                    <td class="px-6 py-3">
