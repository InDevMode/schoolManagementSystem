                  ...
                  <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
                        <div class="mb-4 md:mb-0">
                              <h1 class="text-2xl font-bold text-gray-800 dark:text-white flex items-center">
                                    <i class="fa-solid fa-user-group text-emerald-600 mr-2" width="28"
                                          height="28"></i></span>
                                    Modifier ce parent
                              </h1>
                                          ...
                                          <div class="mb-6 w-full">
                                                ...
                                                <div class="relative">
                                                      <input type="text" id="name" name="name"
                                                            value="{{ old('name', $getParent->name) }}" required
                                          ...
                                          <div class="mb-6 w-full">
                                                ...
                                                <div class="relative">
                                                      <input type="text" id="last_name" name="last_name"
                                                            value="{{ old('last_name', $getParent->last_name) }}" required
                                                            class="form-input w-full px-4 py-3 rounded-lg border border-gray-300 bg-gray-50 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-emerald-500 dark:focus:border-emerald-500 transition-all duration-200"
                                                ...
                                                <div class="relative">
                                                      <select id="gender" name="gender" required
                                                            ...
                                                            <option selected disabled value="">Veuillez choisir un
                                                                  genre pour ce parent
                                                            <option class="text-body" value="male"
                                                                  {{ old('gender', $getParent->gender) == 'male' ? 'selected' : '' }}>
                                                                  Masculin</option>
                                                            <option class="text-body" value="female"
                                                                  {{ old('gender', $getParent->gender) == 'female' ? 'selected' : '' }}>
                                                                  Féminin</option>
                                                            <option class="text-body" value="other"
                                                                  {{ old('gender', $getParent->gender) == 'other' ? 'selected' : '' }}>
                                                                  Autre</option>
                                                      </select>
                                                      <div
                                          ...
                                          <div class="mb-6 w-full">
                                                ...
                                                <div class="relative">
                                                      <input type="text" id="occupation" name="occupation"
                                                            value="{{ old('occupation', $getParent->occupation) }}" required
                                                            class="form-input w-full px-4 py-3 rounded-lg border border-gray-300 bg-gray-50 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-emerald-500 dark:focus:border-emerald-500 transition-all duration-200"
                                                            placeholder="Entrez un occupation">
                                                </div>
                                          </div>
                                    </div>
                                          ...
                                          <div class="mb-6 w-full">
                                                ...
                                                <div class="relative">
                                                      <input type="text" id="mobile_number" name="mobile_number"
                                                            value="{{ old('mobile_number', $getParent->mobile_number) }}" required
                                                            class="form-input w-full px-4 py-3 rounded-lg border border-gray-300 bg-gray-50 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-emerald-500 dark:focus:border-emerald-500 transition-all duration-200"
                                          ...
                                          <div class="mb-6 w-full">
                                                ...
                                                <div class="relative">
                                                      <input type="text" id="address" name="address"
                                                            value="{{ old('address', $getParent->address) }}" required
                                                            class="form-input w-full px-4 py-3 rounded-lg border border-gray-300 bg-gray-50 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-emerald-500 dark:focus:border-emerald-500 transition-all duration-200"
                                    ...
                                    <div class="mb-6">
                                          ...
                                          <div class="relative">
                                                <select id="status" name="status" required
                                                      class="custom-select w-full px-4 py-3 rounded-lg border border-gray-300 bg-gray-50 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-emerald-500 dark:focus:border-emerald-500 transition-all duration-200">
                                                      <option selected disabled value="">Veuillez choisir un
                                                            status pour ce parent
                                                      <option value="1" {{ old('status', $getParent->status) == '1' ? 'selected' : '' }}>
                                                            Active
                                                      </option>
                                                      <option value="0" {{ old('status', $getParent->status) == '0' ? 'selected' : '' }}>
                                                            Inactive
                                                      </option>
                                                </select>
                                                <div
                                          ...
                                          <div class="mb-6 w-full">
                                                ...
                                                <div class="relative">
                                                      <input type="email" id="email" name="email"
                                                            value="{{ old('email', $getParent->email) }}" required
                                                            class="form-input w-full px-4 py-3 rounded-lg border border-gray-300 bg-gray-50 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-emerald-500 dark:focus:border-emerald-500 transition-all duration-200"
                                          ...
                                          <div class="mb-6 w-full">
                                                ...
                                                <div class="relative">
                                                      <input type="password" id="password" name="password"
                                                            value="{{ old('password') }}"
                                                            class="placeholder:text-red-500 w-full px-4 py-3 rounded-lg border border-gray-300 bg-gray-50 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-emerald-500 dark:focus:border-emerald-500 transition-all duration-200"
