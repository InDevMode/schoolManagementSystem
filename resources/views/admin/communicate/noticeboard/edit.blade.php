                            ...
                            <form action="" method="post"
                                ...
                                <div class="p-6.5">
                                    ...
                                    <div class="w-full mb-5">
                                        ...
                                        <input id="title" name="title" value="{{ old('title', $getNoticeBoard->title) }}" required type="text"
                                    ...
                                    <div class="w-full mb-5">
                                        ...
                                        <div class="relative">
                                            <input id="notice_date" name="notice_date" value="{{ old('notice_date', $getNoticeBoard->notice_date) }}"
                                    ...
                                    <div class="w-full mb-5">
                                        ...
                                        <div class="relative">
                                            <input id="publish_date" name="publish_date" value="{{ old('publish_date', $getNoticeBoard->publish_date) }}"
                                                required data-class="flatpickr-right"
                                            ...
                                            <li
                                                ...
                                                <div class="flex items-center ps-3">
                                                    <input id="message_to_teachers" type="checkbox" value="2" name="message_to[]" {{ !empty($message_to_teacher) ? 'checked' : '' }}
                                                        class="w-4 h-4 text-emerald-400 bg-gray-100 border-gray-300 rounded-sm focus:ring-emerald-400 dark:focus:ring-emerald-400 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
