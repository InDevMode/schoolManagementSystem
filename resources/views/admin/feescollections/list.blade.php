      ...
      <div class="container mx-auto px-4 py-5">
            ...
            <div class="relative flex flex-col md:flex-row justify-between items-start md:items-center mb-5 gap-4"
                  ...
                  <div>
                        ...
                        <p class="text-gray-600 dark:text-gray-300 mt-1">Gérez la listes de perceptions des frais de scolarité
                              de
                              votre plateforme</p>
                  </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                              ...
                              <div>
                                    <label for="student_name"
                                          class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">N°
                                          Matricule
                                    </label>
                                    <div class="relative">
                              ...
                              <div>
                                    <label for="student_last_name"
                                          class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Prénoms de
                                          l'Apprenant
                                    </label>
                                    <div class="relative">
                                          <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                              ...
                              <tbody class="z-20 bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    @foreach ($getFeesCollections as $index => $feescollections)
                                          ...
                                          <tr class="hover:bg-violet-100 dark:hover:bg-gray-700 transition-colors">
                                                <td
                                                      class="px-6 py-4 whitespace-nowrap font-medium text-sm text-gray-500 dark:text-gray-400">
                                                                        ...
                                                                        <div x-data="{ showConfirm: false, selectedStudent: null }">
                                                                              <div>
                                                                                    <button type="button"
                                                                                          ...
                                                                                          role="menuitem">
                                                                                          <i
                                                                                                class="fas fa-cash-register mr-2"></i>Ajouter
                                                                                          un frais
                                                                                    </button>
                                                                              </div>
                                                                              ...
                                                                              <div x-show="showConfirm" x-transition x-cloak
                                                                                    ...
                                                                                    <div
                                                                                          ...
                                                                                          <div
                                                                                                ...
                                                                                                <h3
                                                                                                      ...
                                                                                                      contribution pour <span
                                                                                                            ...
                                                                                                            {{ $feescollections->student_last_name }}
                                                                                                      </span> de la
                                                                                                      classe de <span
                                                                                          ...
                                                                                          <div>
                                                                                                <form action="{{ route('createFeesCollects', $feescollections->id) }}"
                                                                                                      x-data="{
                                                                                                      ...
                                                                                                      <div
                                                                                                            class="flex justify-between py-3 rounded-b">
                                                                                                            <button
                                                                                                                  @click="showConfirm = false"
                                                                    ...
                                                                    hover:text-violet-600 dark:hover:text-violet-400 transition-colors duration-200">
                                                                                    ...
                                                                                    <div x-show="showModal"
                                                                                          ...
                                                                                          <div x-show="showModal"
                                                                                                ...
                                                                                                <!-- Header -->
                                                                                                <div
                                                                                                      class="flex items-center justify-between px-6 py-4 bg-gradient-to-r from-violet-600 to-violet-700">
                                                                                                      <h3
                                                                                                ...
                                                                                                <!-- Body -->
                                                                                                <div
                                                                                                      class="px-6 py-6 space-y-8 text-gray-700 dark:text-gray-200">

                                                                                                      <!-- Élève -->
                                                                                                      <div
                                                                                                            class="grid grid-cols-2 gap-6">
                                                                                                            <div
                                                                                                                  class="p-4 rounded-lg bg-gray-50 dark:bg-gray-900/50">
                                                                                                                  <p
                                                                                                      ...
                                                                                                      <div
                                                                                                            ...
                                                                                                            <div
                                                                                                                  class="p-4 rounded-lg bg-blue-50 dark:bg-blue-900/30">
                                                                                                                  <p
                                                                                                                        class="text-sm font-semibold text-gray-500 dark:text-gray-400">
                                                                                                                        Montant
                                                                                                                        total
                                                                                                                  ...
                                                                                                                  <p
                                                                                                                        ...
                                                                                                                        {{ number_format($feescollections->total_amount, 0, ',', ' ') }}
                                                                                                                        FCFA
                                                                                                                  </p>
                                                                                                            </div>
                                                                                                            <div
                                                                                                                  class="p-4 rounded-lg bg-green-50 dark:bg-green-900/30">
                                                                                                                  <p
                                                                                                                        class="text-sm font-semibold text-gray-500 dark:text-gray-400">
                                                                                                                        Montant
                                                                                                                        payé
                                                                                                            ...
                                                                                                            <div
                                                                                                                  class="p-4 rounded-lg bg-red-50 dark:bg-red-900/30">
                                                                                                                  <p
                                                                                                                        class="text-sm font-semibold text-gray-500 dark:text-gray-400">
                                                                                                                        Montant
                                                                                                                        restant
                                                                                                      ...
                                                                                                      <!-- Remarque ajoutée -->
                                                                                                      <div
                                                                                                            class="p-4 rounded-lg border dark:border-gray-700 col-span-2">
                                                                                                            <p
                                                                                                                  class="text-sm font-semibold text-gray-500 dark:text-gray-400">
                                                                                                                  Remarque</p>
                                                                                                            <p
                                                                                                                  class="text-lg font-medium">
                                                                                                                  {{ $feescollections->remark }}
                                                                                                            </p>
                                                                                                      </div>
                                                                                                      ...
                                                                                                      <div
                                                                                                            ...
                                                                                                            <div
                                                                                                                  ...
                                                                                                                  <span
                                                                                                                        class="mt-1 inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold
                                                                                        {{ $type['bg'] }} {{ $type['border'] }} {{ $type['text'] }} {{ $type['dark_bg'] }} {{ $type['dark_text'] }}">
                                                                                                            ...
                                                                                                            <div
                                                                                                                  ...
                                                                                                                  <p
                                                                                                                        class="text-lg font-medium">
                                                                                                                        {{ \Carbon\Carbon::parse($feescollections->created_at)->locale('fr')->translatedFormat('d M Y à H:i:s') }}
                                                                                                                  </p>
                                                                                                            </div>
                                                                                                      </div>
                                                                                                </div>
                                                                                                ...
                                                                                                <!-- Footer -->
                                                                                                <div
                                                                                                      class="flex justify-end px-6 py-4 bg-gray-50 dark:bg-gray-900">
                                                                                                      <button
                                                                                                            @click="showModal = false"
                  ...
                  @if (!empty($getFeesCollections))
                        <div
                              ...
                              <div class="text-sm text-gray-500 dark:text-gray-400">
                                    ...
                                    affiché<span class="">{{ $getFeesCollections->total() > 1 ? 's' : '' }}</span>
                              </div>
