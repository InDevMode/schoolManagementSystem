...
@section('content')
      <div class="container mx-auto px-4 py-5">
                              ...
                              <div class="mb-3">
                                    ...
                                    <div class="relative">
                                          ...
                                          <input type="text" id="class_name" name="class_name"
                                                value="{{ Request::get('class_name') }}" placeholder="Nom de la classe"
                                                class="pl-10 w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-primary-600 focus:border-primary-600 p-2.5">
                                    </div>
                              ...
                              <div>
                                    ...
                                    <div class="relative">
                                          <select id="payment_type" name="payment_type"
                                                ...
                                                <option value="check"
                                                      {{ Request::get('payment_type') === 'check' ? 'selected' : '' }}>Chèque
                                                </option>
                                                <option value="transfer"
                                                      {{ Request::get('payment_type') === 'transfer' ? 'selected' : '' }}>
                                                      Virement</option>
                                                <option value="cash"
                                                      {{ Request::get('payment_type') === 'cash' ? 'selected' : '' }}>En
                                                      espèces</option>
                                          </select>
            ...
            <div class="flex justify-between items-center space-x-2 my-5">
                  ...
                  <span>{{ $getFeesCollections->links('vendor.pagination.tailwind') }}</span>
                  <span>
                        <form action="{{ url('admin/feescollections/feescollects/export') }}" method="post">
                              @csrf
                              ...
                              <input type="hidden" name="class_name" value="{{ Request::get('class_name') }}">
                                          ...
                                          @php
                                                $types = [
                                                    'check' => [
                                                        ...
                                                        'dark_bg' => 'dark:bg-violet-900',
                                                        'dark_text' => 'dark:text-violet-200',
                                                    ],
                                                    'transfer' => [
                                                        'label' => 'Virement',
                                                        'bg' => 'bg-green-100',
                                                    ...
                                                    'stripe' => [
                                                        ...
                                                        'dark_bg' => 'dark:bg-indigo-900',
                                                        'dark_text' => 'dark:text-indigo-200',
                                                    ],
                                                    'kkiapay' => [
                                                        'label' => 'Kkiapay',
                                                        'bg' => 'bg-pink-100',
                                                        ...
                                                        'text' => 'text-pink-800',
                                                        'dark_bg' => 'dark:bg-pink-900',
                                                        'dark_text' => 'dark:text-pink-200',
                                                    ],
                                                ];

                                                $type = $types[$feescollections->payment_type] ?? [
                                                    'label' => 'Inconnu',
                                                    'bg' => 'bg-gray-100',
                                                                  ...
                                                                  <div class="py-1">
                                                                        ...
                                                                        <div x-data="{ showConfirm: false }">
                                                                              <button type="button"
                                                                                    ...
                                                                                    role="menuitem"><i
                                                                                          class="fas fa-eye mr-2"></i>Voir</button>
                                                                              ...
                                                                              <div x-show="showConfirm" x-transition x-cloak
                                                                                    ...
                                                                                    <div
                                                                                          ...
                                                                                          <!-- Body -->
                                                                                          <div
                                                                                                class="px-6 py-6 space-y-6 text-gray-700 dark:text-gray-200">
                                                                                                <!-- Élève -->
                                                                                                <div
                                                                        ...
                                                                        <div x-data="{ showDelete: false }">
                                                                              <button type="button"
                                                                                    ...
                                                                                    role="menuitem"><i
                                                                                          class="fas fa-trash-alt mr-2"></i>Supprimer</button>
                                                                              <!-- MODAL de confirmation -->
