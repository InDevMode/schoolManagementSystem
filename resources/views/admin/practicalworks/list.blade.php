                        ...
                        @foreach($getWorks as $index => $works)
                            <tr class="hover:bg-violet-100 dark:hover:bg-gray-700 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                   <div class="relative inline-block text-left" x-data="{ open: false, showModal: false, showConfirm: false }">
                                        <div>
                                            <button type="button"
                                        ...
                                        <div class="absolute right-0 z-50 mt-2 w-56 origin-top-right rounded-lg bg-white dark:bg-gray-800 ring-1 shadow-lg ring-black/5 focus:outline-hidden"
                                            ...
                                            <div class="py-1">
                                                ...
                                                <a href="{{ url('admin/practicalworks/homework/details', $works->id) }}"
                                                    class="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:text-amber-400 dark:hover:text-amber-400"
                                                    role="menuitem">   <iconify-icon icon="mdi:eye" class="mr-2" width="18" height="18"></iconify-icon>Voir</a>
                                                ...
                                                <div x-data="{ showConfirm: false }">
                                                    ...
                                                    <div x-show="showConfirm" x-transition x-cloak
                                                        ...
                                                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg border-b dark:border-gray-400 w-[30%] h-auto">
                                                            <div class="flex items-center justify-between p-4 border-b border-gray-200 rounded-t bg-violet-500 dark:bg-gray-700">
                                                                <h3 class="text-lg font-semibold text-white dark:text-white">Supprimer un travail de maison</h3>
                                                            ...
                                                            <div class="p-4 text-center text-lg text-gray-800 dark:text-gray-200">
                                                                Êtes-vous sûr de vouloir supprimer ce travail de maison ?
                                                            </div>
                                             ...
                                             <a href="{{ url('admin/practicalworks/homework/submission', $works->id) }}"
