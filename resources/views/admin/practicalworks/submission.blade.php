    ...
    <div class="container mx-auto p-4">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <div>
                ...
                <p class="text-gray-600 dark:text-gray-300 mt-1">Gérez la liste des travaux de maion soumis par l'apprenant de votre plateforme</p>
            </div>
                ...
                <ol class="flex items-center space-x-2">
                    ...
                    <li class="flex items-center">
                        <a href="{{ url('admin/practicalworks/homework/list') }}"
                            ...
                            <iconify-icon icon="mdi:home-edit" class="mr-1" width="18"
