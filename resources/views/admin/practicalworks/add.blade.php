                  ...
                  <div class="bg-white rounded-xl shadow-md overflow-hidden dark:bg-gray-800 transition-colors duration-300">
                        <div class="p-6 md:p-8">
                              <form action="{{ url('admin/practicalworks/homework/add') }}" method="post"
                                    ...
                                    <div class="mb-6">
                                          ...
                                          <div class="relative">
                                                <select id="class_id" name="class_id" required
                                                      ...
                                                      <option selected disabled value="">Choisissez une classe pour cet
                                                            travail de maion
                                                      </option>
                                    ...
                                    <div class="mb-6">
                                          <label
                                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Document</label>
                                                ...
                                                <label for="dropzone-file"
                                                      ...
                                                      <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                                            ...
                                                            <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span
                                                                        class="font-semibold">Cliquez pour télécharger</span>
                                                                  ou glissez-déposez</p>
                                                            <p class="text-xs text-gray-500 dark:text-gray-400">PDF, Word
                                                                  (DOC, DOCX), Excel
                                                                  (XLS, XLSX), PowerPoint (PPT, PPTX), Images (JPG, PNG, GIF)
                                                                  - MAX. 10MB</p>
                                                            <span id="file-name"
                                                                  class="mt-2 text-sm text-violet-600 dark:text-violet-400 font-medium hidden"></span>
                                                      </div>

                                                      <input id="dropzone-file" type="file" name="document_file"
                                                            class="hidden" />
                                                </label>
                                          </div>
                                          ...
                                          <div id="file-type-error"
                                                class="mt-2 text-sm text-red-600 dark:text-red-400 hidden">
                                                Type de fichier non autorisé. Veuillez sélectionner un fichier PDF, Word,
                                                Excel, PowerPoint
                                                ou une image.
                                          </div>
                  ...
                  fetch(`{{ url('admin/practicalworks/homework/getSubjectByClassId/${classId}') }}`)
                        ...
                        .then(data => {
                              subjectSelect.innerHTML =
                                    '<option selected disabled value="">Choisissez une matière</option>';
