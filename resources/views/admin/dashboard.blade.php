...
<body class="">
    ...
    <aside id="logo-sidebar"
        ...
        aria-label="Sidebar">
        <div
            class="h-full px-3 pb-4 overflow-y-auto scrollbar-thin scrollbar-thumb-blue-500 scrollbar-track-gray-200 bg-white dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="#"
                        class="flex items-center p-2 text-gray-900 rounded-md dark:text-white hover:bg-violet-600 dark:hover:bg-gray-700 group transition-all duration-300 ease-out">
                        ...
                        <span class="ms-3 group-hover:text-white dark:group-hover:text-white">Dashboard</span>
                    </a>
                </li>
                <li>
                    <a href="#"
                        class="flex items-center p-2 text-gray-900 rounded-md dark:text-white hover:bg-violet-600 dark:hover:bg-gray-700 group transition-all duration-300 ease-out">
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-300 dark:text-gray-400 group-hover:text-white dark:group-hover:text-white"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 18 18">
                            <path
                        ...
                        <span
                            class="flex-1 ms-3 whitespace-nowrap group-hover:text-white dark:group-hover:text-white">Kanban</span>
                        <span
                ...
                <li>
                    <a href="#"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-violet-600 dark:hover:bg-gray-700 group transition-all duration-300 ease-out">
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-300 dark:text-gray-400 group-hover:text-white dark:group-hover:text-whit"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 20 20">
                            <path
                ...
                <li>
                    <button type="button"
                        class="flex items-center w-full p-2 text-base text-gray-900 transition duration-500 rounded-md group hover:bg-violet-600 dark:text-white dark:hover:bg-gray-700"
                        aria-controls="dropdownCommerce" data-collapse-toggle="dropdownCommerce">
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-300 group-hover:text-white dark:text-gray-400 dark:group-hover:text-white"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 18 21">
                            <path
                        ...
                        <span
                            class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap group-hover:text-white dark:group-hover:text-white">E-commerce</span>
                        <svg class="w-3 h-3 text-gray-500 transition duration-300 group-hover:text-white dark:text-gray-400 dark:group-hover:text-white"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2" d="m1 1 4 4 4-4" />
                        </svg>
                    </button>
                    <ul id="dropdownCommerce" class="hidden py-2 space-y-2">
                        <li>
                            <a href="#"
                                class="flex items-center gap-3 w-full p-2 text-gray-900 transition duration-300 rounded-md group hover:bg-violet-600 dark:text-white dark:hover:bg-gray-700">
                                <svg class=" w-5 h-5 text-gray-500 transition duration-300 dark:text-gray-400 group-hover:text-white dark:group-hover:text-whit"
                                ...
                                <span
                                    class="whitespace-nowrap group-hover:text-white dark:group-hover:text-white">Products</span>
                            </a>
                        </li>
                        <li>
                            <a href="#"
                                ...
                                <span
                                    class="whitespace-nowrap group-hover:text-white dark:group-hover:text-white">Billing</span>
                            </a>
                        </li>
                        <li>
                            <a href="#"
                                ...
                                <span
                                    class="whitespace-nowrap group-hover:text-white dark:group-hover:text-white">Invoice</span>
                            </a>
                        </li>
                ...
                <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                    <li>
                        <a href="#"
                            class="flex items-center p-2 text-gray-900 rounded-md hover:bg-violet-600 dark:hover:bg-gray-700 group transition-all duration-300 ease-out">
                            ...
                            <span class="ms-3 group-hover:text-white dark:group-hover:text-white">Upgrade to Pro</span>
                        </a>
                    </li>
                    <li>
                        <a href="#"
                            ...
                            <span class="ms-3 group-hover:text-white dark:group-hover:text-white">Documentation</span>
                        </a>
                    </li>
                    <li>
                        <a href="#"
                            ...
                            <span class="ms-3 group-hover:text-white dark:group-hover:text-white">Components</span>
                        </a>
                    </li>
                    <li>
                        <a href="#"
                            ...
                            <span class="ms-3 group-hover:text-white dark:group-hover:text-white">Help</span>
                        </a>
                    </li>
                    <li>
                        <a href="#"
