      ...
      <div class="container mx-auto px-4 py-5">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-5 gap-4">
                  <div>
                        ...
                        <p class="text-gray-600 dark:text-gray-300 mt-1">Gérez les évaluations de votre plateforme</p>
                  </div>
                  ...
                  <nav class="flex items-center text-sm">
                        <ol class="flex items-center space-x-2">
                              ...
                              <li class="flex items-center">
                                    <a href="{{ url('admin/examinations/exam/add') }}"
                                          class="text-primary-600 hover:text-violet-600 transition-colors">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-5">
                  ...
                  <form>
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                              ...
                              <div>
                                    <label for="exam_name"
                                          class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Entrer le
                                          nome de l'évaluation</label>
                                    <div class="relative">
                                          ...
                                          <input type="text" id="exam_name" name="exam_name"
                                                ...
                                                placeholder="Entrez un nom de l'évaluation..."
                              ...
                              <div>
                                    <label for="note"
                                          class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Entrer une
                                          note</label>
                                    <div class="relative">
                                          <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                                <i class="fas  fa-square-poll-horizontal text-gray-400"></i>
                              ...
                              <div>
                                    <label for="percent_to"
                                          class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Pourcentage
                                          de</label>
                                    <div class="relative">
                                          <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                          ...
                                          <input type="text" id="percent_to" name="percent_to"
                                                value="{{ Request::get('percent_to') }}"
                                                placeholder="Entrez un pourcentage de..."
                                                class="pl-10 w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-primary-600 focus:border-primary-600 p-2.5">
                                    </div>
                              </div>
                              ...
                              <div>
                                    ...
                                    <div class="relative">
                                          ...
                                          <input type="text" id="percent_from" name="percent_from"
                                                value="{{ Request::get('percent_from') }}"
                                                placeholder="Entrez un pourcentage à..."
                                                class="pl-10 w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-primary-600 focus:border-primary-600 p-2.5">
                                    </div>
                              </div>
            ...
            <div
                              ...
                              <tbody class="z-20 bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                                                                    ...
                                                                                    <div
                                                                                          ...
                                                                                          <div
                                                                                                ...
                                                                                                <div
                                                                                                      ...
                                                                                                      <a href="{{ url('admin/examinations/exam/delete', $exam->id) }}"
                                    ...
                                    @if ($getExams->isEmpty())
                                          <tr class="text-center text-gray-700 dark:text-bodydark1">
                                                <td colspan="100%" class="py-3"> Aucun examen trouvé.</td>
                                          </tr>
                                    @endif
                  ...
                  <div
                        ...
                        <div class="text-sm text-gray-500 dark:text-gray-400">
                              Total de <span class="font-medium">{{ $getExams->total() }}</span> évaluation<span
                                    class="">{{ $getExams->total() > 1 ? 's' : '' }}</span> affichée<span
                                    class="">{{ $getExams->total() > 1 ? 's' : '' }}</span>
                        </div>
