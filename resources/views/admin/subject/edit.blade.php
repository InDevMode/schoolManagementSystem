                  ...
                  <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
                        <div class="mb-4 md:mb-0">
                              <h1 class="text-2xl font-bold text-gray-800 dark:text-white flex items-center">
                                    <i class="fa-solid fa-book-open-reader text-emerald-400 mr-2" width="28"
                                          height="28"></i>
                                          ...
                                          <div class="relative">
                                                <select id="status" name="status" required
                                                      ...
                                                      <option class="text-body" value="practical"
                                                            {{ old('type', $getSubject->type) == 'practical' ? 'selected' : '' }}>
                                                            Pratique</option>
                                                      <option class="text-body" value="theoretical"
                                                            {{ old('type', $getSubject->type) == 'theoretical' ? 'selected' : '' }}>
                                                            Théorique</option>
                                                </select>
                                                <div
                                          ...
                                          <div class="relative">
                                                <select id="status" name="status" required
                                                      ...
                                                      <option selected disabled value="">Veuillez choisir un status
                                                            pour
                                                            la matière
                                                      <option value="1" {{ old('status', $getSubject->status) == '1' ? 'selected' : '' }}>
                                                            Active</option>
                                                      <option value="0" {{ old('status', $getSubject->status) == '0' ? 'selected' : '' }}>
                                                            Inactive</option>
                                                </select>
                                                <div
                                                      class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
