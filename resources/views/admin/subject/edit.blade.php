                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="p-6.5">
                                <div class="mb-4.5">
                                    ...
                                    <input id="name" name="name" value="{{ old('name', $getSubject->name) }}" required
                                           type="text"
                                    ...
                                    >
                                        ...
                                        >
                                            <option selected disabled value="" class="text-body">
                                                Choisissez un type pour cette matière
                                            </option>
                                            <option class="text-body" value="practical" {{ (old('type', $getSubject->type) == 'practical') ? 'selected' : '' }}>Pratique</option>
                                            <option class="text-body" value="theoretical" {{ (old('type', $getSubject->type) == 'theoretical') ? 'selected' : '' }}>Théorique</option>
                                        </select>
                                        <span
                                ...
                                <div class="mb-4.5">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <option class="text-body" value="1" {{ (old('status', $getSubject->status) == '1') ? 'selected' : '' }}>Activée</option>
                                            <option class="text-body" value="0" {{ (old('status', $getSubject->status) == '0') ? 'selected' : '' }}>Désactivée</option>
                                        </select>
                                        <span
                                            class="absolute right-4 top-1/2 z-30 -translate-y-1/2"
                                        >
