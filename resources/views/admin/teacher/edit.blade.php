                ...
                >
                    ...
                    <nav>
                        <ol class="flex items-center gap-2">
                            <li>
                                <span class="font-medium text-emerald-400"><i class="fa-solid fa-user-tie"></i></span>
                            </li>
                            <li>
                                /<a class="font-medium hover:text-emerald-400 transition duration-300" href="{{ url('admin/teacher/list') }}"> Liste des professeurs</a>
                            </li>
                        </ol>
                    </nav>
                </div>
                            ...
                            <div class="p-6.5">
                                ...
                                <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                                    <div class="w-full xl:w-1/2">
                                        ...
                                        <input id="name" name="name" value="{{ old('name', $getTeacher->name) }}"
                                               required
                                               type="text"
                                    ...
                                    <div class="w-full xl:w-1/2">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                'gender', $getTeacher->gender) == 'male') ? 'selected' : ''
                                                }}>Masculin</option>
                                                <option class="text-body" value="female" {{ (old(
                                                'gender', $getTeacher->gender) == 'female') ? 'selected' : ''
                                                }}>Féminin</option>
                                                <option class="text-body" value="other" {{ (old(
                                                'gender', $getTeacher->gender) == 'other') ? 'selected' : ''
                                                }}>Autre</option>
                                            </select>
                                            <span
                                ...
                                <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                                    <div class="w-full xl:w-1/2">
                                        <label
                                            class="mb-3 block text-sm font-medium text-black dark:text-white"
                                        >
                                            Date d'Adhésion <span class="text-meta-1">*</span>
                                        </label>
                                        <div class="relative">
                                    ...
                                    <div class="w-full xl:w-1/2">
                                        ...
                                        <textarea
                                            ...
                                            class="w-full rounded-lg border-[1.5px] border-stroke bg-gray-100 px-5 py-2.5 font-normal text-black outline-none transition focus:border-emerald-400 active:border-emerald-400 disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-emerald-400"
                                        >{{ old('qualification', $getTeacher->qualification) }}</textarea>
                                    </div>
                                </div>
                                <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                                    <div class="w-full xl:w-1/2">
                                    ...
                                    <div class="w-full xl:w-1/2">
                                        <label
                                            class="mb-3 block text-sm font-medium text-black dark:text-white"
                                        >
                                            Situation Matrimoniale <span class="text-meta-1">*</span>
                                        </label>
                                ...
                                <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                                    <div class="w-full xl:w-1/2">
                                        <label
                                            class="mb-3 block text-sm font-medium text-black dark:text-white"
                                        >
                                            Adresse Actuelle <span class="text-meta-1">*</span>
                                        </label>
                                        <textarea
                                            rows="1" id="address" name="address"
                                            placeholder="Entrez un adresse actuelle"
                                            class="w-full rounded-lg border-[1.5px] border-stroke bg-gray-100 px-5 py-2.5 font-normal text-black outline-none transition focus:border-emerald-400 active:border-emerald-400 disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-emerald-400"
                                        >{{ old('address', $getTeacher->address) }}</textarea>
                                    </div>
                                    <div class="w-full xl:w-1/2">
                                        <label
                                            class="mb-3 block text-sm font-medium text-black dark:text-white"
                                        ...
                                        <textarea
                                            ...
                                            class="w-full rounded-lg border-[1.5px] border-stroke bg-gray-100 px-5 py-2.5 font-normal text-black outline-none transition focus:border-emerald-400 active:border-emerald-400 disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-emerald-400"
                                        >{{ old('permanent_address', $getTeacher->permanent_address) }}</textarea>
                                    </div>
                                </div>
                                <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                                    <div class="w-full xl:w-1/2">
                                        ...
                                        <textarea
                                            ...
                                            class="w-full rounded-lg border-[1.5px] border-stroke bg-gray-100 px-5 py-2.5 font-normal text-black outline-none transition focus:border-emerald-400 active:border-emerald-400 disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-emerald-400"
                                        >{{ old('work_experience', $getTeacher->work_experience) }}</textarea>
                                    </div>
                                    <div class="w-full xl:w-1/2">
                                        <label
                                            class="mb-3 block text-sm font-medium text-black dark:text-white"
                                        ...
                                        <textarea
                                            ...
                                            class="w-full rounded-lg border-[1.5px] border-stroke bg-gray-100 px-5 py-2.5 font-normal text-black outline-none transition focus:border-emerald-400 active:border-emerald-400 disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-emerald-400"
                                        >{{ old('note', $getTeacher->note) }}</textarea>
                                    </div>
                                </div>
                                <div class="mb-4.5">
                                    <label
                                    ...
                                    >
                                        ...
                                        >
                                            <option selected disabled value="" class="text-body">
                                                Choisissez un statut pour cet professeur
                                            </option>
                                            <option class="text-body" value="1" {{ (old(
                                            'status', $getTeacher->status) == '1') ? 'selected' : '' }}>Actif</option>
                                            <option class="text-body" value="0" {{ (old(
                                            'status', $getTeacher->status) == '0') ? 'selected' : '' }}>Inactif</option>
                                        </select>
                                        <span
                                            class="absolute right-4 top-1/2 z-30 -translate-y-1/2"
                                        >
