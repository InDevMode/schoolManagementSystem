                ...
                <form action="" method="post" class="p-5" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-2 gap-x-5">
                        <div class="mb-3">
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name', $getTeacher->name) }}"
                                   class="rounded bg-gray-100 border border-gray-300 text-gray-900 focus:ring-violet-500 focus:border-violet-500 block w-full text-sm ps-3"
                        ...
                        <div class="mb-3">
                            <label class="block mb-2 text-sm font-medium text-gray-900" for="last_name">Prénom<span
                                    class="text-red-500 font-bold">*</span></label>
                            <input type="text" id="last_name" name="last_name" value="{{ old('last_name', $getTeacher->last_name) }}"
                                   class="rounded bg-gray-100 border border-gray-300 text-gray-900 focus:ring-violet-500 focus:border-violet-500 block w-full text-sm ps-3"
                        ...
                        <div class="mb-5">
                            ...
                            <select id="gender" name="gender"
                                ...
                                <option {{ (old('gender', $getTeacher->gender) == 'male') ? 'selected' : '' }} value="male">Masculin</option>
                                <option {{ (old('gender', $getTeacher->gender) == 'female') ? 'selected' : '' }} value="female">Féminin</option>
                                <option {{ (old('gender', $getTeacher->gender) == 'other') ? 'selected' : '' }} value="other">Autre</option>
                            </select>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="text" id="address" name="address" value="{{ old('address', $getTeacher->address) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="text" id="permanent_address" name="permanent_address" value="{{ old('permanent_address', $getTeacher->permanent_address) }}"
                                      class="rounded bg-gray-100 border border-gray-300 text-gray-900 focus:ring-violet-500 focus:border-violet-500 block w-full text-sm"
                                      placeholder="addresse permanent...">{{ old('address', $getTeacher->address) }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label class="block mb-2 text-sm font-medium text-gray-900" for="qualification">Qualification</label>
                            <textarea type="text" id="qualification" name="qualification" value="{{ old('qualification', $getTeacher->qualification) }}"
                                      class="rounded bg-gray-100 border border-gray-300 text-gray-900 focus:ring-violet-500 focus:border-violet-500 block w-full text-sm"
                                      placeholder="qualification...">{{ old('qualification', $getTeacher->qualification) }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label class="block mb-2 text-sm font-medium text-gray-900" for="work_experience">Expérience</label>
                            <textarea type="text" id="work_experience" name="work_experience" value="{{ old('work_experience', $getTeacher->work_experience) }}"
                                      class="rounded bg-gray-100 border border-gray-300 text-gray-900 focus:ring-violet-500 focus:border-violet-500 block w-full text-sm"
                                      placeholder="expérience de travail...">{{ old('work_experience', $getTeacher->work_experience) }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label class="block mb-2 text-sm font-medium text-gray-900" for="note">Note</label>
                            <textarea type="text" id="note" name="note" value="{{ old('note', $getTeacher->note) }}"
                                      class="rounded bg-gray-100 border border-gray-300 text-gray-900 focus:ring-violet-500 focus:border-violet-500 block w-full text-sm"
                                      placeholder="note...">{{ old('note', $getTeacher->note) }}</textarea>
                        </div>
                    </div>
                    <div class="mb-5">
                    ...
                    <div class="border-t-2 border-gray-300 mt-3 mb-5 pt-3">
                        <div class="mb-3">
                            <label class="block mb-2 text-sm font-medium text-gray-900" for="email">Email<span
                                    class="text-red-500 font-bold">*</span></label>
                            <input type="email" id="email" name="email" value="{{ old('email', $getTeacher->email) }}"
                                   class="rounded bg-gray-100 border border-gray-300 text-gray-900 focus:ring-violet-500 focus:border-violet-500 block w-full text-sm ps-3"
