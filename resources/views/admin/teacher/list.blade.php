    ...
    >
        ...
        <nav>
            <ol class="flex items-center gap-2">
                ...
                <li>
                    /<a class="font-medium hover:text-violet-600 transition duration-300"
                        href="{{ url('admin/teacher/add') }}"> Créer un professeur</a>
                </li>
            </ol>
        </nav>
    </div>
    ...
    >
        <form action="" method="get">
            <div class="mb-4.5 grid grid-cols-2 xl:grid-cols-4 gap-3 items-center">
                ...
                <div class="w-full">
                    <div class="relative">
                        <input id="admission_date" name="admission_date" value="{{ Request::get('admission_date') }}"
                ...
                <tr class="hover:bg-violet-100 dark:hover:bg-gray-700 transition duration-300 border-b dark:border-gray-600 hover:border-violet-400 dark:text-gray-200 text-gray-500">
                    ...
                    <td class="px-6 py-3">
                        <div class="flex items-center">
                            <P class="h-2.5 w-2.5 rounded-full {{ $teacher->status == 1 ? 'bg-emerald-500' : 'bg-red-500' }} me-2"></P>
                            <p>{{ $teacher->status == 1 ? 'Actif' : 'Inactif' }}</p>
                        </div>
                    </td>
                    <td class="px-6 py-3">
                    ...
                    <td class="px-6 py-3">
                        <div class="flex items-center">
                            <p class="px-6 py-1 rounded-full {{ $teacher->gender == 'male' ? 'text-violet-700 dark:text-gray-200 bg-violet-100 dark:bg-violet-900' : ($teacher->gender == 'female' ? 'text-red-700 dark:text-gray-200 bg-red-100 dark:bg-red-900' : 'text-pink-700 dark:text-gray-200 bg-pink-100 dark:bg-pink-900') }}">
