      ...
      <div class="container mx-auto px-4 py-5">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-5 gap-4">
                  <div>
                        ...
                        <p class="text-gray-600 dark:text-gray-300 mt-1">Gérez les comptes professeurs de votre plateforme</p>
                  </div>
                              ...
                              <div>
                                    ...
                                    <div class="relative">
                                          ...
                                          <input type="date" id="updated_at" name="updated_at"
                                                placeholder="Jour/Mois/Année" value="{{ Request::get('updated_at') }}"
                                                class="pl-10 w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-primary-600 focus:border-primary-600 p-2.5">
                                    </div>
                              </div>
            ...
            <div class="flex justify-between items-center space-x-2 my-5">
                  <span> {{ $getTeacher->links('vendor.pagination.tailwind') }}</span>
                  <span>
                        <form action="{{ url('admin/teacher/export') }}" method="POST">
                              @csrf
            ...
            <div
                              ...
                              <tbody class="z-20 bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                          ...
                                          <tr class="hover:bg-violet-100 dark:hover:bg-gray-700 transition-colors">
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                      <div class="flex items-center">
                                                            <div class="">
                                                                  <span
                                                                        class="text-sm font-medium text-gray-900 dark:text-white">{{ $teacher->name }}</span>
                                                                  <span
                                                                        class="text-sm text-gray-500 dark:text-gray-400">{{ $teacher->last_name }}</span>
                                                            </div>
                                                      </div>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                      <span
                                                            class="px-2 py-1 border w-24 inline-flex justify-center text-xs leading-5 font-semibold rounded-full {{ $teacher->status == 1 ? 'bg-green-100 border-green-800 text-green-800 dark:bg-green-900 dark:text-green-200' : 'bg-red-100 border-red-800 text-red-800 dark:bg-red-900 dark:text-red-200' }}">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                      <span
                                                            class="px-2 py-1 border w-24 inline-flex justify-center text-xs leading-5 font-semibold rounded-full {{ $teacher->gender == 'male' ? 'bg-violet-100 border-violet-800 text-violet-800 dark:bg-violet-900 dark:text-violet-200' : ($teacher->gender == 'female' ? 'bg-red-100 border-red-800 text-red-800 dark:bg-red-900 dark:text-red-200' : 'bg-pink-100 border-pink-800 text-pink-800 dark:bg-pink-900 dark:text-pink-200') }}">
                                                            {{ $teacher->gender == 'male' ? 'Masculin' : ($teacher->gender == 'female' ? 'Féminin' : 'Autre') }}
                                                      </span>
                                                </td>
                                                <td
                                                      class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                                      {{ \Carbon\Carbon::parse($teacher->date_of_birth)->locale('fr')->translatedFormat('d M Y') }}
                                                </td>
                                                <td
                                                      class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                                      {{ \Carbon\Carbon::parse($teacher->admission_date)->locale('fr')->translatedFormat('d M Y') }}
                                                </td>
                                                <td
                                                      class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                                      {{ \Carbon\Carbon::parse($teacher->created_at)->locale('fr')->translatedFormat('d M Y H:i:s') }}
                                                </td>
                                                <td
                                                      class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                                      {{ \Carbon\Carbon::parse($teacher->updated_at)->locale('fr')->translatedFormat('d M Y H:i:s') }}
                                                </td>
                                    ...
                                    @if ($getTeacher->isEmpty())
                                          <tr class="text-center text-gray-700 dark:text-bodydark1">
                                                <td colspan="10" class="py-3"> Aucun professeur trouvé.</td>
                                          </tr>
                                    @endif
                              </tbody>
                        </table>
                  ...
                  <div
                        ...
                        <div class="text-sm text-gray-500 dark:text-gray-400">
                              Total de <span class="font-medium">{{ $getTeacher->total() }}</span> professeur<span
                                    class="">{{ $getTeacher->total() > 1 ? 's' : '' }}</span> affiché<span
                                    class="">{{ $getTeacher->total() > 1 ? 's' : '' }}</span>
                        </div>
