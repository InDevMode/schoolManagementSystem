            ...
            <div class="w-full max-w-7xl bg-white shadow-lg mt-2 rounded-md">
                ...
                <form action="" method="post" class="p-5" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-2 gap-x-5">
                        <div class="mb-3">
                            <label class="block mb-2 text-sm font-medium text-gray-900" for="name">Nom<span class="text-red-500 font-bold">*</span></label>
                        ...
                        <div class="mb-3">
                            <label class="block mb-2 text-sm font-medium text-gray-900" for="last_name">Prénom<span class="text-red-500 font-bold">*</span></label>
                            <input type="text" id="last_name" name="last_name" value="{{ $getStudent -> last_name }}"
                                   class="rounded bg-gray-100 border border-gray-300 text-gray-900 focus:ring-violet-500 focus:border-violet-500 block w-full text-sm ps-3"
                                   placeholder="prénom..." required>
                        </div>
                        <div class="mb-3">
                            <label class="block mb-2 text-sm font-medium text-gray-900" for="admission_number">Numéro d'admission<span class="text-red-500 font-bold">*</span></label>
                        ...
                        <div class="mb-3">
                            <label class="block mb-2 text-sm font-medium text-gray-900" for="roll_number">Numéro de Rôle</label>
                            <input type="text" id="roll_number" name="roll_number" value="{{ $getStudent -> roll_number }}"
                                   class="rounded bg-gray-100 border border-gray-300 text-gray-900 focus:ring-violet-500 focus:border-violet-500 block w-full text-sm ps-3"
                                   placeholder="numéro de rôle...">
                        </div>
                        <div class="mb-5">
                            <label class="block mb-2 text-sm font-medium text-gray-900" for="class_id">Classe<span class="text-red-500 font-bold">*</span></label>
                            <select id="class_id" name="class_id"
                                    class="rounded bg-gray-100 border border-gray-300 text-gray-900 focus:ring-violet-500 focus:border-violet-500 block w-full text-sm ps-3"
                                    required>
                                <option disabled selected>Attribuez une classe à cet élève</option>
                                @foreach($getClass as $class)
                                <option {{ $getStudent->class_id == $class->id ? 'selected' : '' }} value="{{ $class->id}}">{{ $class->name }}
                                </option>
                            </select>
                        </div>
                        <div class="mb-5">
                            <label class="block mb-2 text-sm font-medium text-gray-900" for="gender">Genre<span class="text-red-500 font-bold">*</span></label>
                            <select id="gender" name="gender"
                                    class="rounded bg-gray-100 border border-gray-300 text-gray-900 focus:ring-violet-500 focus:border-violet-500 block w-full text-sm ps-3"
                                    required>
                                <option disabled selected>Choisissez un genre à cet élève</option>
                                <option value="male" {{ $getStudent->gender == 'male' ? 'selected' : ''}}>Masculin</option>
                                <option value="female" {{ $getStudent->gender == 'female' ? 'selected' : ''}}>Féminin</option>
                                <option value="other" {{ $getStudent->gender == 'other' ? 'selected' : ''}}>Autre</option>
                            </select>
                        </div>
                        <div class="mb-3">
                            <label class="block mb-2 text-sm font-medium text-gray-900" for="date_of_birth">Date d'anniversaire<span class="text-red-500 font-bold">*</span></label>
                            <input type="date" id="date_of_birth" name="date_of_birth" value="{{ $getStudent -> date_of_birth }}"
                                   class="rounded bg-gray-100 border border-gray-300 text-gray-900 focus:ring-violet-500 focus:border-violet-500 block w-full text-sm ps-3"
                        ...
                        <div class="mb-3">
                            <label class="block mb-2 text-sm font-medium text-gray-900" for="mobile_number">Numéro de téléphone</label>
                        ...
                        <div class="mb-3">
                            <label class="block mb-2 text-sm font-medium text-gray-900" for="admission_date">Date d'admission<span class="text-red-500 font-bold">*</span></label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" id="profile_picture" name="profile_picture"
                                   value="{{ $getStudent->profile_picture }}"
                                   class="rounded bg-gray-100 border border-gray-300 text-gray-900 focus:ring-violet-500 focus:border-violet-500 block w-full text-sm ps-3"
                                   placeholder="Photo de profile...">
                        </div>
                        <div class="mb-5">
                            <label class="block mb-2 text-sm font-medium text-gray-900" for="blood_group">Groupe Sanguin</label>
                            <select id="blood_group" name="blood_group"
                                ...
                                <option value="b-" {{ $getStudent->blood_group == 'b-' ? 'selected' : ''}} >B-</option>
                                <option value="ab+" {{ $getStudent->blood_group == 'ab+' ? 'selected' : ''}} >AB+</option>
                                <option value="ab-" {{ $getStudent->blood_group == 'ab-' ? 'selected' : ''}} >AB-</option>
                        ...
                        <div class="mb-5">
                            <label class="block mb-2 text-sm font-medium text-gray-900" for="status">Status<span class="text-red-500 font-bold">*</span></label>
                            <select id="status" name="status"
                                ...
                                <option value="0" name="status" {{ $getStudent->status == 0 ? 'selected' : ''}}>Désactivée
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="border-t-2 border-gray-300 mt-3 mb-5 pt-3">
                        <div class="mb-3">
                            <label class="block mb-2 text-sm font-medium text-gray-900" for="email">Email<span class="text-red-500 font-bold">*</span></label>
