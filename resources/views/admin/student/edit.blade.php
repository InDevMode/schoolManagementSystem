                  ...
                  <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
                        <div class="mb-4 md:mb-0">
                              <h1 class="text-2xl font-bold text-gray-800 dark:text-white flex items-center">
                                    <iconify-icon icon="fa-solid:user-graduate" class="text-emerald-600 mr-2" width="28"
                              ...
                              <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-6">
                                          ...
                                          <div class="relative">
                                                <input type="file" id="profile_picture" name="profile_picture"
                                                      ...
                                                      class="w-full cursor-pointer rounded-lg border-[1.5px] border-stroke bg-gray-50 font-normal outline-none transition file:mr-5 file:border-collapse file:cursor-pointer file:border-0 file:border-r file:border-solid file:border-stroke file:bg-whiter file:px-5 file:py-3 file:hover:bg-emerald-400 file:hover:bg-opacity-10 focus:border-violet-400 active:border-emerald-400 disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:file:border-form-strokedark dark:file:bg-white/30 dark:file:text-white dark:focus:border-emerald-400">
                                          </div>
                                    </div>
                                    <img src="{{ $profile_picture_url }}" alt="profile cover"
                                          class="w-32 my-3 rounded-full object-cover object-center" />
                                          ...
                                          <div class="mb-6 w-full">
                                                ...
                                                <div class="relative">
                                                      <input type="text" id="name" name="name"
                                                            ...
                                                            class="form-input w-full px-4 py-3 rounded-lg border border-gray-300 bg-gray-50 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-violet-500 dark:focus:border-emerald-500 transition-all duration-200"
                                    ...
                                    <div class="lg:flex items-center justify-between lg:space-x-3">
                                          <div class="mb-6 w-full">
                                                <label
                                                      class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                                      Numéro d'Admission <span class="text-red-500">*</span>
                                                </label>
                                                <div class="relative">
                                          ...
                                          <div class="mb-6 w-full">
                                                <label
                                                      class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                                      Numéro de Rôle <span class="text-red-500">*</span>
                                                </label>
                                                <div class="relative">
                                          ...
                                          <div class="mb-6 w-full">
                                                ...
                                                <div class="relative">
                                                      <select id="gender" name="gender" required
                                                            class="custom-select w-full px-4 py-3 rounded-lg border border-gray-300 bg-gray-50 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-emerald-500 dark:focus:border-violet-500 transition-all duration-200">
                                                            <option selected disabled value="">Veuillez choisir un
                                                                  genre pour cet apprenant
                                                            <option class="text-body" value="male"
                                                                  {{ old('gender', $getStudent->gender) == 'male' ? 'selected' : '' }}>
                                                                  Masculin</option>
                                                            <option class="text-body" value="female"
                                                                  {{ old('gender', $getStudent->gender) == 'female' ? 'selected' : '' }}>
                                                                  Féminin</option>
                                                            <option class="text-body" value="other"
                                                                  {{ old('gender', $getStudent->gender) == 'other' ? 'selected' : '' }}>
                                                                  Autre</option>
                                                      </select>
                                                      <div
                                    ...
                                    <div class="lg:flex items-center justify-between lg:space-x-3">
                                          ...
                                          <div class="mb-6 w-full">
                                                <label
                                                      class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                                      Date d'Admission <span class="text-red-500">*</span>
                                                </label>
                                                <div class="relative">
                                                      <div
                                                            class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                          ...
                                          <div class="mb-6 w-full">
                                                ...
                                                <div class="relative">
                                                      <select id="blood_group" name="blood_group" required
                                                            class="custom-select w-full px-4 py-3 rounded-lg border border-gray-300 bg-gray-50 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-emerald-500 dark:focus:border-emerald-500 transition-all duration-200">
                                                            <option selected disabled value="">Veuillez choisir
                                                                  un group sanguin pour cet
                                                                  apprenant
                                                            <option class="text-body" value="a+"
                                                                  {{ old('blood_group', $getStudent->blood_group) == 'a+' ? 'selected' : '' }}>
                                                                  A+</option>
                                                            <option class="text-body" value="a-"
                                                                  {{ old('blood_group', $getStudent->blood_group) == 'a-' ? 'selected' : '' }}>
                                                                  A-</option>
                                                            <option class="text-body" value="b+"
                                                                  {{ old('blood_group', $getStudent->blood_group) == 'b+' ? 'selected' : '' }}>
                                                                  B+</option>
                                                            <option class="text-body" value="b-"
                                                                  {{ old('blood_group', $getStudent->blood_group) == 'b-' ? 'selected' : '' }}>
                                                                  B-</option>
                                                            <option class="text-body" value="ab+"
                                                                  {{ old('blood_group', $getStudent->blood_group) == 'ab+' ? 'selected' : '' }}>
                                                                  AB+</option>
                                                            <option class="text-body" value="ab-"
                                                                  {{ old('blood_group', $getStudent->blood_group) == 'ab-' ? 'selected' : '' }}>
                                                                  AB-</option>
                                                            <option class="text-body" value="o+"
                                                                  {{ old('blood_group', $getStudent->blood_group) == 'o+' ? 'selected' : '' }}>
                                                                  O+</option>
                                                            <option class="text-body" value="o-"
                                                                  {{ old('blood_group', $getStudent->blood_group) == 'o-' ? 'selected' : '' }}>
                                                                  O-</option>
                                    ...
                                    <div class="mb-6">
                                          ...
                                          <div class="relative">
                                                <select id="status" name="status" required
                                                      class="custom-select w-full px-4 py-3 rounded-lg border border-gray-300 bg-gray-50 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-emerald-500 dark:focus:border-emerald-500 transition-all duration-200">
                                                      <option selected disabled value="">Veuillez choisir un
                                                            status pour cet apprenant
                                                      <option value="1"
                                                            {{ old('status', $getStudent->status) == '1' ? 'selected' : '' }}>
                                                            Active
                                                      </option>
                                                      <option value="0"
                                                            {{ old('status', $getStudent->status) == '0' ? 'selected' : '' }}>
                                                            Inactive
                                                      </option>
                                                </select>
                                                <div
