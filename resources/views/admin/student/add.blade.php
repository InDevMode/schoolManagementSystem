                            ...
                            <div class="p-6.5">
                                    ...
                                    <div class="w-full xl:w-1/2">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <option class="text-body" value="a+" {{ (old('blood_group') == '1') ? 'selected' : '' }}>A+</option>
                                                <option class="text-body" value="a-" {{ (old('blood_group') == '0') ? 'selected' : '' }}>A-</option>
                                                <option class="text-body" value="b+" {{ (old('blood_group') == '0') ? 'selected' : '' }}>B+</option>
                                                <option class="text-body" value="b-" {{ (old('blood_group') == '0') ? 'selected' : '' }}>B-</option>
                                                <option class="text-body" value="ab+" {{ (old('blood_group') == '0') ? 'selected' : '' }}>AB+</option>
                                                <option class="text-body" value="ab-" {{ (old('blood_group') == '0') ? 'selected' : '' }}>AB-</option>
                                                <option class="text-body" value="o+" {{ (old('blood_group') == '0') ? 'selected' : '' }}>O+</option>
                                                <option class="text-body" value="o-" {{ (old('blood_group') == '0') ? 'selected' : '' }}>O-</option>
                                            </select>
                                            <span
                                                class="absolute right-4 top-1/2 z-30 -translate-y-1/2"
                                ...
                                <div class="mb-4.5">
                                    ...
                                    <input
                                        ...
                                        class="w-full rounded border-[1.5px] border-stroke bg-gray-100 px-5 py-2.5 font-normal text-black outline-none transition focus:border-violet-600 active:border-violet-600 disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-violet-600"
                                    />
                                </div>
                                <div class="mb-4.5">
                                    <label
                                ...
                                <button type="submit"
                                        class="flex w-full justify-center rounded-lg bg-violet-600 p-3 font-medium text-white hover:bg-opacity-90"
                                >
                                    Créer
                                </button>
                            </div>
