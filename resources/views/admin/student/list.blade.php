    ...
    >
        ...
        <nav>
            <ol class="flex items-center gap-2">
                <li>
                    <span class="font-medium text-violet-600"><i class="fa-solid fa-user-graduate"></i></span>
                </li>
                <li>
                ...
                <div class="w-full">
                    ...
                    >
                        ...
                        >
                            ...
                            <option value="male" class="text-body" {{ Request::get(
                            'blood_group') == 'a+' ? 'selected' : '' }}>A+</option>
                            <option value="male" class="text-body" {{ Request::get(
                            'blood_group') == 'a-' ? 'selected' : '' }}>A-</option>
                            <option value="male" class="text-body" {{ Request::get(
                            'blood_group') == 'b+' ? 'selected' : '' }}>B+</option>
                            <option value="female" class="text-body" {{ Request::get(
                            'blood_group') == 'b-' ? 'selected' : '' }}>B-</option>
                            <option value="other" class="text-body" {{ Request::get(
                            'blood_group') == 'ab+' ? 'selected' : '' }}>AB+</option>
                            <option value="other" class="text-body" {{ Request::get(
                            'blood_group') == 'ab-' ? 'selected' : '' }}>AB-</option>
                            <option value="other" class="text-body" {{ Request::get(
                            'blood_group') == 'o+' ? 'selected' : '' }}>O+</option>
                            <option value="other" class="text-body" {{ Request::get(
                            'blood_group') == 'o-' ? 'selected' : '' }}>O-</option>
                        </select>
                        <span
                ...
                <tr class="hover:bg-violet-100 dark:hover:bg-gray-700 transition duration-300 border-b dark:border-gray-600 hover:border-violet-400 dark:text-gray-200 text-gray-500">
                    ...
                    <td class="px-6 py-3">
                        <div class="flex items-center">
                            <P class="h-2.5 w-2.5 rounded-full {{ $student->status == 1 ? 'bg-emerald-500' : 'bg-red-500' }} me-2"></P>
                            <p>{{ $student->status == 1 ? 'Actif' : 'Inactif' }}</p>
                        </div>
                    </td>
                    <td class="px-6 py-3">
                    ...
                    <td class="px-6 py-3">
                        <div class="flex items-center">
                            <p class="px-6 py-1 rounded-full {{ $student->gender == 'male' ? 'text-violet-700 dark:text-gray-200 bg-violet-100 dark:bg-violet-900' : ($student->gender == 'female' ? 'text-red-700 dark:text-gray-200 bg-red-100 dark:bg-red-900' : 'text-pink-700 dark:text-gray-200 bg-pink-100 dark:bg-pink-900') }}">
