                                ...
                                <div class="mb-4.5">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <option class="text-body" value="1" {{ (old('status', $getAdmin->status) == '1') ? 'selected' : '' }}>Actif</option>
                                            <option class="text-body" value="0" {{ (old('status', $getAdmin->status) == '0') ? 'selected' : '' }}>Inactif</option>
                                        </select>
                                        <span
