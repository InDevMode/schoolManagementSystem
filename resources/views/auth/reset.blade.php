                                    ...
                                    <div class="mb-5">
                                          ...
                                          <form action="" method="POST">
                                                ...
                                                <div class="space-y-5">
                                                      ...
                                                      <div>
                                                            <x-form.password label="Nouveau mot de passe" id="password"
                                                                  icon="mdi:lock" placeholder="Entrez votre nouveau mot de passe"
                                                                  required></x-form.password>

                                                            <x-form.password label="Confirmez le nouveau mot de passe" id="confPassword"
                                                                  icon="mdi:lock" placeholder="Confirmez votre nouveau mot de passe"
                                                                  required></x-form.password>
                                                      </div>
                                                      ...
                                                      <x-form.button text="text-white"
                                                            icon="mdi:check-circle" label="Réinitialiser"></x-form.button>
                                                </div>
                                          </form>
