...
<head>
      ...
      <title>{{ !empty($header_title) ? $header_title : 'Réinitalisation' }} - School</title>
...
<body class="" x-data="{ page: 'signin', 'loaded': true, 'darkMode': true, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }" x-init="darkMode = JSON.parse(localStorage.getItem('darkMode'));
                                          ...
                                          <div class="hidden w-full xl:block xl:w-1/2">
                                                <div class="px-26 py-17.5 text-center">
                                                      <span class="mt-15 inline-block">
                                                            <img src="{{ asset('public/images/connexion.png') }}"
                                                                  alt="illustration" />
                                                      </span>
                                                </div>
                                          </div>
                                          <div
                                                ...
                                                <div class="w-full p-4 sm:p-12.5 xl:p-17.5">
                                                      ...
                                                      <form action="" method="post">
                                                            ...
                                                            <div class="mb-6">
                                                                  <label
                                                                        class="mb-2.5 block font-medium text-black dark:text-white">Nouveau
                                                                        mot
                                                                        de passe</label>
                                                                  <div class="relative">
                                                                        ...
                                                                        <span class="absolute right-4 top-4 cursor-pointer"
                                                                              ...
                                                                              <iconify-icon id="toggleNewPasswordIcon"
                                                                                    icon="mdi:lock"
                                                            ...
                                                            <div class="mb-6">
                                                                  <label
                                                                        class="mb-2.5 block font-medium text-black dark:text-white">Confirmez
