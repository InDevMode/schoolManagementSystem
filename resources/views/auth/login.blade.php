    ...
    <div class="flex flex-col lg:flex-row items-center gap-2">
        ...
        <div class="w-full rounded-l-none rounded-md p-5">
            ...
            <form action="{{ url('login') }}" method="post" class="">
                ...
                <button type="submit"
                        class="flex items-center justify-center gap-x-3 text-pink-500 border border-gray-400 group focus:ring-4 focus:outline-none focus:ring-pink-300 font-medium rounded-md text-sm px-5 py-2.5 text-center w-full mb-3 transition-all ease-in-out duration-700 hover:-translate-y-2 hover:translate-x-2 hover:bg-pink-600 hover:border-pink-600">
