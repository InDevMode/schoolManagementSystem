...
@section('content')
    <div class="m-5">
        ...
        <style>
            /* Animations personnalisées pour les cartes */
            .notification-card {
        ...
        @php
            $totalNotifications = $getStudentNoticeboard->count();
            $studentCount = $getStudentNoticeboard->filter(function ($notification) {
                return $notification->getNoticeBoardMessage->contains('message_to', '3');
            })->count();
        @endphp
                        ...
                        @php
                            ...
                            $getBadgeClass = function ($type) {
                                switch ($type) {
                                    case '3':
                                    default:
                                        return 'bg-gray-100 text-gray-700 hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-200';
                                }
                            };
                        @endphp
                                ...
                                <div>
                                    ...
                                    <div x-data="{ expanded: false }">
                                        ...
                                        <button @click="expanded = !expanded" x-transition.duration.300ms x-cloak
                                            class="mt-2 bg-violet-600 py-2 px-4 text-white rounded-md shadow-lg dark:text-white hover:bg-opacity-90 text-sm font-medium">
