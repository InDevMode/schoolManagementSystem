                            ...
                            <div class="p-6.5">
                                ...
                                <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                                    <div class="w-full xl:w-1/2">
                                        ...
                                        <input id="name" name="name" value="{{ old('name', $getUserData->name) }}"
                                               required
                                               type="text"
                                ...
                                <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                                    ...
                                    <div class="w-full xl:w-1/2">
                                        ...
                                        <input id="caste" name="caste"
                                               value="{{ old('caste', $getUserData->caste) }}"
                                               required
                                               type="text"
                                    ...
                                    <div class="w-full xl:w-1/2">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <option class="text-body" value="a+" {{ (old('blood_group', $getUserData->blood_group) == 'a+') ? 'selected' : '' }}>A+</option>
                                                <option class="text-body" value="a-" {{ (old('blood_group', $getUserData->blood_group) == 'a-') ? 'selected' : '' }}>A-</option>
                                                <option class="text-body" value="b+" {{ (old('blood_group', $getUserData->blood_group) == 'b+') ? 'selected' : '' }}>B+</option>
                                                <option class="text-body" value="b-" {{ (old('blood_group', $getUserData->blood_group) == 'b-') ? 'selected' : '' }}>B-</option>
                                                <option class="text-body" value="ab+" {{ (old('blood_group', $getUserData->blood_group) == 'ab+') ? 'selected' : '' }}>AB+</option>
                                                <option class="text-body" value="ab-" {{ (old('blood_group', $getUserData->blood_group) == 'ab-') ? 'selected' : '' }}>AB-</option>
                                                <option class="text-body" value="o+" {{ (old('blood_group', $getUserData->blood_group) == 'o+') ? 'selected' : '' }}>O+</option>
                                                <option class="text-body" value="o-" {{ (old('blood_group', $getUserData->blood_group) == 'o-') ? 'selected' : '' }}>O-</option>
                                            </select>
                                            <span
                                                class="absolute right-4 top-1/2 z-30 -translate-y-1/2"
