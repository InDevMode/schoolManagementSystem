                        ...
                        <div class="mb-4.5 grid grid-cols-2 3xl:grid-cols-5 gap-3 items-center">
                              <div class="w-full">
                                    <input type="text" id="subject_name" name="subject_name"
                                          value="{{ Request::get('subject_name') }}" placeholder="nom de la matière..."
                                    ...
                                    <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-gray-100 dark:bg-form-input">
                                          <select id="subject_type" name="subject_type"
                                                ...
                                                <option value="0" class="text-body"
                                                      {{ Request::get('subject_type') == 'theoretical' ? 'selected' : '' }}>
                                                      Théorique</option>
                                                <option value="1" class="text-body"
                                                      {{ Request::get('subject_type') == 'practical' ? 'selected' : '' }}>
                                                      Pratique</option>
                                          </select>
                              ...
                              <div class="w-full">
                                    <input type="text" id="teacher_name" name="teacher_name"
                                          value="{{ Request::get('teacher_name') }}" placeholder="nom du professeur..."
                                          class="w-full rounded-lg border-[1.5px] border-stroke bg-gray-100 px-5 py-2.5 font-normal text-black outline-none transition focus:border-violet-600 active:border-violet-600 disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-violet-600" />
                              </div>
                              <div class="w-full">
                                    <button
                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-white dark:text-white">
                              ...
                              <tbody>
                                    @foreach ($getStudentSubject as $index => $mySubject)
                                          <tr
                                                class="hover:bg-violet-100 dark:hover:bg-gray-700 transition duration-300 border-b dark:border-gray-600 hover:border-violet-400 dark:text-gray-200 text-gray-500">
                                                <td class="px-6 py-3">
                                                ...
                                                <td class="px-6 py-3">
                                                      <div class="flex items-center">
                                                            <p
                                                                  class="px-6 py-1 rounded-full {{ $mySubject->subject_type == 'practical' ? 'text-violet-700 dark:text-gray-200 bg-violet-100 dark:bg-violet-900' : 'text-red-700 dark:text-gray-200 bg-red-100 dark:bg-red-900' }}">
                                    ...
                                    <tr class="">
                                          <td colspan="3" class="px-6 py-3">
                                                <div class="mt-3 mb-3 flex items-center justify-between">
                                                      <h2
                                                            class="text-title-sm uppercase font-bold text-black dark:text-white">
                                                            Total
                                                      </h2>
                                                      <nav>
                                                            <ol
                                                                  ...
                                                                  <li>
                                                                        <p
                                                                              class="text-md font-semibold text-gray-700 dark:text-gray-200">
