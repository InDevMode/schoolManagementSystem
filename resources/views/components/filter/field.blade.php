      ...
      <div class="relative">
            ...
            @if ($type === 'select')
                  <select id="{{ $id }}" name="{{ $id }}"
                       ...
                       bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-violet-600 focus:border-violet-600 p-2.5 pr-8 outline-none">
            ...
            @else
                  <input type="{{ $type }}" id="{{ $id }}" name="{{ $id }}"
                       ...
                       bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-violet-600 focus:border-violet-600 p-2.5 outline-none">
            @endif
      </div>
</div>
