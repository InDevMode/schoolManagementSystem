...
<div class="p-4 sm:ml-64">
    <div class="p-4 rounded-lg mt-14">
        ...
        <div class="p-4 flex items-center justify-center">
            <div class="w-full max-w-screen-md bg-white shadow-lg mt-24 rounded-lg">
                @include('message')
                ...
                <form action="" method="post" class="p-5">
                    ...
                    <div class="flex mb-5">
                        <input type="password" id="old_password" name="old_password" value=""
                               class="rounded-lg bg-gray-100 border border-gray-300 text-gray-900 focus:ring-violet-500 focus:border-violet-500 block w-full text-sm ps-3"
