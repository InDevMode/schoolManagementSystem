...
<body
    class="flex justify-center items-center h-screen backImage">
    <div class="bg-violet-100 rounded-md">
        <div class="w-full h-full shadow-2xl border-t-0 border-violet-200 rounded-md border-2">
            <h1 class="hidden lg:block text-xl font-bold text-center uppercase text-white rounded-t bg-violet-500 p-3">
                School Management System
            </h1>
            <form
                class="p-4">
                <h2
                    class="text-xl font-bold uppercase text-center  text-gray-700 rounded-t-md mb-3">
                    Connectez-vous</h2>
                <div class="flex mb-5">
                    <span
                    ...
                    <input type="email" id="email"
                        class="rounded-none rounded-e-md bg-white border border-gray-300 text-gray-900 focus:ring-violet-500 focus:border-violet-500 block flex-1 min-w-0 w-full text-sm p-2  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-violet-500 dark:focus:border-violet-500"
                ...
                <div
                    ...
                    <span class="flex items-start">
                        ...
                        <label for="remember_token" class="ms-2 text-sm font-medium text-gray-700 dark:text-gray-300">Se
                            souvenir
                            de moi</label>
                    </span>
                    <button type="submit"
