<aside :class="sidebarToggle ? 'translate-x-0' : '-translate-x-full'"
    ...
    <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        <!-- Sidebar Menu -->
        <nav class="px-4 py-4 lg:px-6 mb-8" x-data="{ selected: $persist('dashboard') }">
            <!-- Menu Group -->
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    @if (Auth::user()->user_type === 1)
                        ...
                        <li>
                            <a class="group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium text-violet-600 duration-300 ease-in-out hover:bg-violet-600 dark:hover:bg-meta-4"
                                ...
                                <span class="group-hover:text-bodydark1 dark:text-bodydark1">Devoirs
                                </span>
                                <span
                                    class="text-[18px] py-1 px-2 rounded bg-violet-100 text-violet-600 transition duration-700 absolute right-4 top-1/2 -translate-y-1/2 fill-current"
                                    :class="{
                                                              'rotate-180 transition duration-700': (
                                                                  selected === 'practicalworks')
                                                          }"><i class="fa-solid fa-chevron-down"></i></span>
                            </a>
                            <!-- Dropdown Menu Start -->
                            <div class="translate transform overflow-hidden transition duration-700"
                                        ...
                                        <a class="group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium duration-300 ease-in-out hover:bg-violet-700 text-bodydark1 dark:hover:bg-meta-4 {{ Request::Segment(3) == 'homework' ? 'bg-violet-600 text-bodydark1' : 'text-violet-600' }}"
                                            ...
                                            <span
                                                class="text-[18px] py-1 px-2 rounded {{ Request::Segment(3) == 'homework' ? 'group-hover:text-bodydark1 text-bodydark1' : 'group-hover:text-bodydark1 text-violet-600 dark:text-bodydark1' }}"><i
                                                    class="fa-solid fa-chevron-right"></i></span>
                                            <span
                                                class="{{ Request::Segment(3) == 'homework' ? 'group-hover:text-bodydark1' : 'group-hover:text-bodydark1 text-violet-600 dark:text-bodydark1' }}">Travaux
                                                Maison</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a class="group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium duration-300 ease-in-out hover:bg-violet-700 text-bodydark1 dark:hover:bg-meta-4 {{ Request::Segment(3) == 'reports' ? 'bg-violet-600 text-bodydark1' : 'text-violet-600' }}"
                                            href="{{ url('admin/practicalworks/reports') }}">
                                            <span
                                                class="text-[18px] py-1 px-2 rounded {{ Request::Segment(3) == 'reports' ? 'group-hover:text-bodydark1 text-bodydark1' : 'group-hover:text-bodydark1 text-violet-600 dark:text-bodydark1' }}"><i
                                                    class="fa-solid fa-chevron-right"></i></span>
                                            <span
                                                class="{{ Request::Segment(3) == 'reports' ? 'group-hover:text-bodydark1' : 'group-hover:text-bodydark1 text-violet-600 dark:text-bodydark1' }}">Rapports</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li>
                            <a class="group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium text-violet-600 duration-300 ease-in-out hover:bg-violet-600 dark:hover:bg-meta-4"
                                ...
                                <span class="group-hover:text-bodydark1 dark:text-bodydark1">Contributions
                                </span>
                                <span
                                    class="text-[18px] py-1 px-2 rounded bg-violet-100 text-violet-600 transition duration-700 absolute right-4 top-1/2 -translate-y-1/2 fill-current"
                                    :class="{
                                                              'rotate-180 transition duration-700': (
                                                                  selected === 'feescollections')
                                                          }"><i class="fa-solid fa-chevron-down"></i></span>
                            </a>
                            <!-- Dropdown Menu Start -->
                            <div class="translate transform overflow-hidden transition duration-700"
                        ...
                        <li>
                            <a class="group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium text-violet-600 duration-300 ease-in-out hover:bg-violet-600 dark:hover:bg-meta-4"
                                ...
                                :class="{ 'bg-gray-100 dark:bg-meta-4': (selected === 'settings') }">
                                <span
                                    class="w-10 h-10 flex items-center justify-center rounded bg-violet-100 text-violet-600"><iconify-icon
                                        icon="mdi:settings" width="24" height="24"></iconify-icon>
                                </span>
                                <span class="group-hover:text-bodydark1 dark:text-bodydark1">Paramètres
                                </span>
                                <span
                                    class="text-[18px] py-1 px-2 rounded bg-violet-100 text-violet-600 transition duration-700 absolute right-4 top-1/2 -translate-y-1/2 fill-current"
                                    :class="{
                            ...
                            <div class="translate transform overflow-hidden transition duration-700"
                                ...
                                <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-8">
                                    <li>
                                        <a class="group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium duration-300 ease-in-out hover:bg-violet-700 text-bodydark1 dark:hover:bg-meta-4 {{ Request::Segment(2) == 'settings' ? 'bg-violet-600 text-bodydark1' : 'text-violet-600' }}"
                                            href="{{ url('admin/settings') }}">
                                            <span
                                                class="text-[18px] py-1 px-2 rounded {{ Request::Segment(2) == 'settings' ? 'group-hover:text-bodydark1 text-bodydark1' : 'group-hover:text-bodydark1 text-violet-600 dark:text-bodydark1' }}"><i
                                                    class="fa-solid fa-chevron-right"></i></span>
                                            <span
                                                class="{{ Request::Segment(2) == 'settings' ? 'group-hover:text-bodydark1' : 'group-hover:text-bodydark1 text-violet-600 dark:text-bodydark1' }}">Menus</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    @endif
                    <ul>
                        <li class="absolute bottom-2 left-0 px-4 py-2 w-full mt-8">
                            <a href="{{ url('logout') }}"
