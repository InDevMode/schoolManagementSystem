            ...
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    <li>
                        ...
                        >
                            <span class="w-10 h-10 flex items-center justify-center rounded bg-violet-100 text-violet-600"><i class="fa-solid fa-arrows-spin text-[18px]"></i></span>
                    ...
                    <li>
                        ...
                        >
                            <span class="w-10 h-10 flex items-center justify-center rounded bg-violet-100 text-violet-600"><i class="fa-solid fa-flask-vial text-[18px]"></i></span>
                    ...
                    <li>
                        ...
                        >
                            <span class="w-10 h-10 flex items-center justify-center rounded bg-violet-100 text-violet-600"><i class="fa-solid fa-user-check text-[18px]"></i></span>
                        ...
                        >
                            <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-8">
                                <li>
                                    <a
                                        class="group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium duration-300 ease-in-out hover:bg-violet-700 text-bodydark1 dark:hover:bg-meta-4 {{ Request::Segment(3) == 'student' ? 'bg-violet-600 text-bodydark1' : 'text-violet-600' }}"
                    ...
                    <li>
                        ...
                        >
                            <span
                                class="w-10 h-10 flex items-center justify-center rounded {{ Request::Segment(2) == 'my_exam_timetable' ? 'bg-violet-100 text-violet-600' : 'bg-violet-100 text-violet-600'}}"><i class="fa-solid fa-flask-vial text-[18px]"></i></span>
                            <span
                    ...
                    <li>
                        <a
                            class="group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium duration-300 ease-in-out hover:bg-violet-700 text-bodydark1 dark:hover:bg-meta-4 {{ Request::Segment(2) == 'my_calendar' ? 'bg-violet-600 text-bodydark1' : 'text-violet-600' }}"
                    ...
                    <li>
                        <a
                            class="group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium duration-300 ease-in-out hover:bg-violet-700 text-bodydark1 dark:hover:bg-meta-4 {{ Request::Segment(2) == 'marks_register' ? 'bg-violet-600 text-bodydark1' : 'text-violet-600' }}"
                            href="{{ url('teacher/marks_register') }}"
                        >
                            <span
                                class="w-10 h-10 flex items-center justify-center rounded {{ Request::Segment(2) == 'marks_register' ? 'bg-violet-100 text-violet-600' : 'bg-violet-100 text-violet-600'}}"><i class="fa-solid fa-registered text-[18px]"></i></span>
                            <span
                    ...
                    <li>
                        <a
                            class="group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium duration-300 ease-in-out hover:bg-violet-700 text-bodydark1 dark:hover:bg-meta-4 {{ Request::Segment(2) == 'my_exam_result' ? 'bg-violet-600 text-bodydark1' : 'text-violet-600' }}"
