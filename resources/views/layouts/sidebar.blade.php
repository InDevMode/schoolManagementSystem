        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <button type="button"
                        ...
                        aria-controls="dropdown-assign"
                        data-collapse-toggle="dropdown-assign"
                        ...
                        <span class="flex-shrink-0 transition duration-700 group-hover:text-white">
                            <i class="fa-solid fa-arrows-rotate"></i>
                                    ...
                                    <span id="chevron" class="group-hover:text-white transition-transform duration-700">
                    ...
                    <li>
                        <a href="{{ url('admin/assign_subject/list') }}"
                           class="flex items-center p-2 rounded pl-8 hover:bg-violet-600 transition-all duration-700 ease-out group {{ Request::Segment(2) == 'assign_subject' ? 'bg-violet-500' : 'text-violet-500'}}">
                            ...
                            <span class="flex-1 ms-3 whitespace-nowrap group-hover:text-white">Matières</span>
                        </a>
                    </li>
                    <li>
            ...
            <li>
                <a href="{{ url('teacher/class_subject') }}"
                   class="flex items-center p-2 rounded hover:bg-violet-600 transition-all duration-700 ease-out group {{ Request::Segment(2) == 'class_subject' ? 'bg-violet-500' : 'text-violet-500' }}">
                    <span
                        class="flex-shrink-0 transition duration-75 group-hover:text-white {{ Request::Segment(2) == 'class_subject' ? 'text-white' : 'text-violet-500'}}">
                        <i class="fa-solid fa-landmark"></i>
                    </span>
                    <span
                        class="flex-1 ms-3 whitespace-nowrap group-hover:text-white {{ Request::Segment(2) == 'class_subject' ? 'group-hover:text-white' : 'text-violet-500'}}">Classes & Matières</span>
                </a>
            </li>
            ...
            <li>
                <a href="{{ url('parent/my_student') }}"
                   class="flex items-center p-2 rounded hover:bg-violet-600 transition-all duration-700 ease-out group {{ Request::Segment(2) == 'my_student' ? 'bg-violet-500' : 'text-violet-500' }}">
                    <span
                        class="flex-shrink-0 transition duration-75 group-hover:text-white {{ Request::Segment(2) == 'my_student' ? 'text-white' : 'text-violet-500'}}">
                        <i class="fa-solid fa-user-graduate"></i>
                    </span>
                    <span
                        class="flex-1 ms-3 whitespace-nowrap group-hover:text-white {{ Request::Segment(2) == 'my_student' ? 'group-hover:text-white' : 'text-violet-500'}}">Mes Elèves</span>
                </a>
            </li>
            @endif
            <ul>
