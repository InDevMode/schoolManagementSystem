        ...
        <div class="flex justify-between pt-2 mb-5">
            <div class="space-x-2 font-semibold">
                ...
                <span class="hover:underline hover:text-violet-500 transition-all duration-300">
                    <a href="{{ url('parent/dashboard') }}">Dashboard</a>
                </span>
                <span><i class="fa-solid fa-chevron-right"></i></span>
                <a class="hover:underline hover:text-violet-500 transition-all duration-300" href="{{ url('parent/my_student/'.$getStudent->id.'/subject') }}">Liste des cours et horaires disponibles</a>
                <span><i class="fa-solid fa-chevron-right"></i></span>
                <span>{{ $getStudent->name }} {{ $getStudent->last_name }} </span>
            </div>
        </div>
