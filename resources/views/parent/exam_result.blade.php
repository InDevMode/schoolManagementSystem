      ...
      <div class="m-5">
            ...
            <div class="mb-6 mt-3 flex flex-col gap-3 sm:flex-row items-center justify-between">
                  <h2 class="uppercase font-bold text-black dark:text-bodydark">
                        Les résultats d'examens <span class="text-violet-500">{{ $getStudent->name }}
            ...
            @foreach ($getExamResultStudent as $index => $examResult)
                  <div class="flex justify-between items-center py-3">
                        ...
                        <a href="{{ url('parent/my_student/exam_result/print?exam_id=' . $examResult['exam_id'] . '' . '&student_id=' . $getStudent->id) }}"
                              ...
                              <tbody class="z-20 bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    @else
                                          ...
                                          @foreach ($examResult['subject'] as $subjectValue)
                                                @php
                                                      $total_class_work =
                                                          $total_class_work + $subjectValue['class_work'];
                                                ...
                                                @endphp
                                                <tr
                                                      class="hover:bg-violet-100 dark:hover:bg-gray-700 text-gray-800 dark:text-gray-200 transition-colors">
                                                      ...
                                                      <td class="px-6 py-3">
                                                            {{ $subjectValue['passing_marks'] }} /
                                                            {{ $subjectValue['full_marks'] }}
                                                      </td>
                                                      <td class="px-6 py-3">
                                          ...
                                          @endforeach
                                          <tr
                                                class="hover:bg-violet-100 text-gray-800 dark:text-gray-200 dark:hover:bg-gray-700 transition-colors">
                                                <td class="px-6 py-3">
                                                ...
                                                <td class="px-6 py-3">
                                                      <span class="font-semibold uppercase">{{ $total_class_work }}
                                                      </span>
                                                </td>
                                                <td class="px-6 py-3">
                                                      <span class="font-semibold uppercase">{{ $total_home_work }}
                                                      </span>
                                                </td>
                                                <td class="px-6 py-3">
                                                      <span class="font-semibold uppercase">{{ $total_test_work }}
                                                      </span>
                                                </td>
                                                <td class="px-6 py-3">
                                                      <span class="font-semibold uppercase">{{ $total_exam_work }}
                                                      </span>
                                                </td>
                                                <td class="px-6 py-3">
                                                ...
                                                <td class="px-6 py-3">
                                                      <span class="font-semibold uppercase">{{ $passing_marks }} /
                                                            {{ $full_marks }} </span>
                                                </td>
                                                <td class="px-6 py-3">
                                                      @if ($subjectValue['score_marks'] >= $subjectValue['passing_marks'])
