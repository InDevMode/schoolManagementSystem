                    ...
                    >
                        <div v-if="showDetails"
                            ...
                            <div class="px-6 py-4 border-t border-gray-200 dark:border-gray-700">
                                <a v-if="detailsTarget"
                                   :href="`/chat?receiver_id=${detailsTarget.id_encoded}`"
                                   class="flex items-center justify-center gap-2 w-full px-4 py-2.5 rounded-xl bg-primary-600 hover:bg-primary-700 text-white text-sm font-semibold transition-colors shadow-sm">
