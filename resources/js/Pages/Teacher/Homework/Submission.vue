<template>
    <div class="space-y-6">
        <PageHeader title="Soumissions des apprenants" subtitle="Travaux soumis par les apprenants" color="indigo">
            ...
            <template #actions>
                <Link href="/teacher/practicalworks/homework/list" class="inline-flex items-center gap-2 px-3 py-2 rounded-xl border border-gray-200 dark:border-gray-700 text-sm font-medium text-gray-500 hover:text-primary-600 hover:border-primary-400 dark:text-gray-400 dark:hover:text-primary-400 transition-colors">
