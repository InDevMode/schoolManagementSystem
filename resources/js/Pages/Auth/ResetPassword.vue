<template>
    <GuestLayout>
        <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-6 text-center">Nouveau mot de passe</h2>
        ...
        <form @submit.prevent="submit" class="space-y-4">
            ...
            <AppInput
                ...
                placeholder="••••••••"
                required
                :error="form.errors.confPassword"
            >
                <template #suffix>
                    <button type="button" class="text-gray-400 hover:text-gray-600 transition-colors" @click="showConfirm = !showConfirm">
