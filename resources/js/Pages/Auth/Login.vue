<template>
    <GuestLayout>
        ...
        <div class="space-y-3 mb-6">
            <a href="/auth/google"
               class="flex items-center justify-center gap-3 w-full py-3 px-4 rounded-lg font-medium text-sm transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]"
               :style="oauthBtnStyle">
        ...
        <form @submit.prevent="submit" class="space-y-4">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input
                        ...
                        placeholder="••••••••••"
                        required
                        class="w-full pl-10 pr-12 py-3 rounded-lg text-sm outline-none transition-all duration-200 focus:ring-2 focus:ring-primary-500"
            ...
            <button
                ...
                class="w-full py-3.5 px-4 rounded-lg font-semibold text-sm text-white transition-all duration-200 mt-2 flex items-center justify-center gap-2 hover:opacity-90 active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed"
