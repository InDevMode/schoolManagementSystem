        ...
        <div class="card p-6 space-y-6">
            ...
            <div class="flex items-center gap-5">
                ...
                <div>
                    ...
                    <label class="mt-2 inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-xl border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer transition-colors">
