<template>
    <div class="space-y-6">
        <!-- Header -->
        <PageHeader title="Classes" :subtitle="`${classes.total} classe(s) enregistr�e(s)`" color="primary">
            <template #icon>
                        ...
                        <div v-if="showDetails" class="relative w-full max-w-sm bg-white dark:bg-gray-900 h-full shadow-2xl flex flex-col">
                            ...
                            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500 dark:text-gray-400">Informations compl�tes</p>
                                    </div>
                                </div>
                            ...
                            <div v-if="detailsTarget" class="flex-1 overflow-y-auto px-6 py-5 space-y-5">
                                ...
                                <div class="rounded-xl bg-gray-50 dark:bg-gray-800 p-4">
                                    <p class="text-xs font-medium text-gray-400 dark:text-gray-500 uppercase tracking-wide mb-1">Frais de scolarit�</p>
...
const handleDelete = (ids: (string | number)[]) => {
    ids.forEach(id => {
        router.get(`/admin/class/delete/${id}`, {}, {
            onSuccess: () => toast.success('Classe supprim�e avec succ�s.'),
