<template>
    <div class="space-y-6">
        <PageHeader title="Présence des apprenants" subtitle="Définissez la présence pour une classe et une date" color="cyan">
            <template #icon>
...
// Normalise toutes les valeurs numériques ou textuelles vers une clé standard
...
// Récupère la valeur existante pour un student_id,
// en cherchant aussi bien avec la clé number qu'avec la clé string (robustesse JSON)
...
// attendance : clés toujours en string pour éviter toute ambiguïté
