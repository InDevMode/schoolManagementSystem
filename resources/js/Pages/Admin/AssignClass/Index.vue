        ...
        >
            ...
            <template #actions="{ row }">
                <div class="flex items-center justify-end gap-1.5">
                    ...
                    <button title="Supprimer" @click="tableRef?.confirmDelete(row.id as number, `${row.class_name} — ${row.teacher_last_name} ${row.teacher_name}`)"
                            class="p-1.5 rounded-lg transition-all duration-150
                    ...
                    >
                        <div v-if="showDetails" class="relative w-full max-w-sm bg-white dark:bg-gray-900 h-full shadow-2xl flex flex-col">
                            ...
                            <div v-if="detailsTarget" class="flex-1 overflow-y-auto px-6 py-5 space-y-5">
                                <!-- Infos principales -->
                                <div class="rounded-lg bg-emerald-50 dark:bg-emerald-900/20 p-4 space-y-4">
