        ...
        <div class="card p-5">
            ...
            <div class="flex items-start gap-3 mt-4 px-4 py-3 rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700">
                ...
                <div class="text-xs text-amber-700 dark:text-amber-300 space-y-0.5">
                    <p class="font-semibold">Pensez à régénérer les bulletins après chaque validation de notes.</p>
                    <p>
                        Si vous avez validé de nouvelles notes depuis la dernière génération, les bulletins existants
                        affichent encore les <strong>anciennes moyennes</strong>.
                        Cliquez sur <strong>« Générer tous les bulletins »</strong> pour les recalculer et mettre à jour les rangs.
                    </p>
                </div>
            </div>
        </div>
