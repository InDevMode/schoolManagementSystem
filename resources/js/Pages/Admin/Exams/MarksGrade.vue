<template>
    <div class="space-y-6">
        ...
        <DataTable
            ref="tableRef"
            :columns="columns"
            :rows="marksGrades.data"
            row-key="id"
            export-filename="bareme-notes"
            @delete="handleDelete"
        >
...
const handleDelete = (ids: (string | number)[]) => {
    ids.forEach(id => {
        router.get(`/admin/examinations/marks_grade/delete/${id}`, {}, {
            onSuccess: () => toast.success('Barème supprimé avec succès.'),
