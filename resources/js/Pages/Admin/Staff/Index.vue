            ...
            <div v-for="member in staff.data" :key="member.id"
                ...
                <div class="flex items-center gap-2 pt-2 border-t border-gray-100 dark:border-gray-700">
                    <button v-if="can('action.staff.edit')"
                        class="flex-1 text-xs font-medium py-1.5 rounded-lg bg-primary-50 dark:bg-primary-900/20 text-primary-700 dark:text-primary-400 hover:bg-primary-100 dark:hover:bg-primary-900/40 transition-colors"
