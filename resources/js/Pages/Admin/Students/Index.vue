    ...
    <div class="space-y-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex items-center gap-2">
                <a href="/admin/student/export" class="inline-flex items-center gap-1.5 px-3 py-2 text-sm font-medium rounded-xl border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
        ...
        <div class="card p-4">
            <div class="grid grid-cols-1 sm:grid-cols-4 gap-3">
                ...
                <AppSelect v-model="filters.class_name" :options="classOptions" placeholder="Toutes les classes" @change="applyFilters" />
        ...
        <div class="card overflow-hidden">
            <AppTable :columns="columns" :rows="tableRows" :pagination="students" row-key="id">
...
const filters = ref({ name: '', email: '', class_name: '', status: '' });
