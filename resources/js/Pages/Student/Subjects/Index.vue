<template>
    <div class="space-y-6">
        ...
        <!-- Header -->
        <PageHeader title="Mes Matières" :subtitle="`${subjects.data?.length ?? 0} matière${(subjects.data?.length ?? 0) > 1 ? 's' : ''} assignée${(subjects.data?.length ?? 0) > 1 ? 's' : ''}`" color="violet">
            <template #icon>
                        ...
                        <div class="flex items-center gap-2 flex-wrap">
                            ...
                            <span v-if="subject.subject_type"
                                ...
                                <span class="w-1.5 h-1.5 rounded-full"
                                      :class="typeDot(subject.subject_type)"/>
