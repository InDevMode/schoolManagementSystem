<template>
    <div class="space-y-6">
        ...
        <!-- Header -->
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Mes Enfants</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
                {{ myStudents.data.length }} enfant{{ myStudents.data.length > 1 ? 's' : '' }} enregistré{{ myStudents.data.length > 1 ? 's' : '' }}
            </p>
        </div>
